#
# Module manifest for module 'Akamai.IAM'
#
...
GUID = '72412da6-29b9-4edc-898d-50faaa86c420'
...
Description = 'Functions to manage the Akamai Identity & Access Management API.'
...
FunctionsToExport = 'Block-IAMPropertyUsers', 'Disable-IAMAPICredential', 
               'Disable-IAMIPAllowList', 'Enable-IAMIPAllowList', 
               'Get-AccountSwitchKey', 'Get-IAMAccessibleGroups', 
               'Get-IAMAdminContactTypes', 'Get-IAMAdminCountries', 
               'Get-IAMAdminLanguages', 'Get-IAMAdminPasswordPolicy', 
               'Get-IAMAdminProducts', 'Get-IAMAdminStates', 
               'Get-IAMAdminTimeoutPolicy', 'Get-IAMAdminTimeZones', 
               'Get-IAMAllowedAPIs', 'Get-IAMAllowedCPCodes', 'Get-IAMAPIClient', 
               'Get-IAMAPICredential', 'Get-IAMAuthorizedUsers', 'Get-IAMCIDRBlock', 
               'Get-IAMGrantableRole', 'Get-IAMGroup', 
               'Get-IAMGroupMoveAffectedUsers', 'Get-IAMIPAllowListStatus', 
               'Get-IAMProperty', 'Get-IAMPropertyResources', 'Get-IAMPropertyUsers', 
               'Get-IAMRole', 'Get-IAMUser', 'Get-IAMUserBlockedProperties', 
               'Get-IAMUserContactTypes', 'Get-IAMUserCountries', 
               'Get-IAMUserLanguages', 'Get-IAMUserPasswordPolicy', 
               'Get-IAMUserProducts', 'Get-IAMUserProfile', 'Get-IAMUserStates', 
               'Get-IAMUserTimeoutPolicy', 'Get-IAMUserTimeZones', 
               'Lock-IAMAPIClient', 'Lock-IAMUser', 'Move-IAMGroup', 
               'Move-IAMProperty', 'New-IAMAPIClient', 'New-IAMAPICredential', 
               'New-IAMCIDRBlock', 'New-IAMGroup', 'New-IAMRole', 'New-IAMUser', 
               'Remove-IAMAPIClient', 'Remove-IAMAPICredential', 
               'Remove-IAMCIDRBlock', 'Remove-IAMGroup', 'Remove-IAMRole', 
               'Remove-IAMUser', 'Reset-IAMUserMFA', 'Reset-IAMUserPassword', 
               'Set-IAMAPIClient', 'Set-IAMAPICredential', 'Set-IAMCIDRBlock', 
               'Set-IAMGroup', 'Set-IAMRole', 'Set-IAMUser', 
               'Set-IAMUserBlockedProperties', 'Set-IAMUserGroupAndRole', 
               'Set-IAMUSerMFA', 'Set-IAMUserNotifications', 'Set-IAMUserPassword', 
               'Set-IAMUserProfile', 'Test-IAMCIDRBlock', 'Unlock-IAMAPIClient', 
               'Unlock-IAMUser'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBZekVrDUbaJ19B
# UbUqSiWNAQs4PFPJodB+ILz7YBGDq6CCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQ