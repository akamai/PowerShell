    ...
    function flatten($Group) {
        ...
        $Group.SubGroups | ForEach-Object {
            ...
            if ($SubGroups.count -eq 1) {
                $Output.Add($SubGroups)
            }
            elseif ($SubGroups.count -gt 1) {
                $Output.AddRange($SubGroups)
            }
        }
        return $Output
    }

    $Path = "/identity-management/v3/user-admin/groups/$($PSBoundParameters.GroupID)"
    $QueryParameters = @{
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDGISHq4KdYvArM
# PUxZv/SskGND2jaScnCvVgFxiwHNJaCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQg+1arrYEUBEgWs0JZ6jxddglUy3qUoRDCJyaY6QGXsiMw
# DQYJKoZIhvcNAQEBBQAEggIATTmeollH+V4SIiAwuBBLWdXiZLDF53DTRBAXANUc
# kjcnYSo2EgIkRO/TeCqg3mBB6VyGbtgFXfwuwDCCnph906vIBnwJd78Hl4bwg+cR
# qEskOSh8HsvYQSp6lazIoy2hvKD/sZt7ZDIfsqGWwfxnN9JcYpX6p1NoSIN168uz
# 0xuKnqPgdroKuWM336xVLvasP/HUdNNxh4t4VHjQ+2ZC4gDcq3jPi2I3TToOh04f
# 1ZFJuElOoCMf2PwSPZ54lAiqyh26tfVhp5JR481Fa9M2DzK5G7s2h1dST7W+Xl/L
# P77z9RUiaIJ8D0ivfONOBxHRSZhc6pEGpsZDCpzH2W8IrTT8VIGaFx+IKgE3Op47
# kIzQg0hrExelORH4QZArq8lIYWCEe51vYepElLyA03q7lJCO8s5LjU0EJIVOwSXG
# GTwITyd9eB/LBrk2rsL7+R0KX7LWoKNQZ5emkVjPFW0yfVysVlj0/CkOoN8EPWOe
# dY6qOcoLeSdP9D2uAFEh4DX12XyeuUAOF7mzg1tyCMumJhHxIvlHK85OcXBs+bJ7
# MwE5Ya1rLzNkaqmMaUeLHeykOLEgtOlGE33awNVymLIui3e908PQnLppeE17mkJI
# a04vuWj3MGkMWM4EnF1Ak37oHwUS9ogdHDQP0/OeX1/OGMxAQ0Tu0x6jm/LFreBB
# eQGhghdAMIIXPAYKKwYBBAGCNwMDATGCFywwghcoBgkqhkiG9w0BBwKgghcZMIIX
# FQIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEEoGkEZzBlAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQg9bQf0L7ec4cC6u26pMvTQZrvykUn
# MUHAdF79yk/znSwCEQDK2U5tVB2JZ5NjCZnhrTLfGA8yMDI0MDQxMTE2MDg1NVqg
...
# DQYLKoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI0MDQxMTE2MDg1NVowKwYL
# KoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLCyQ+CXc6qisnGTxmcz0AwLwYJKoZI
# hvcNAQkEMSIEILlUvjQPJWtWTZVCVIaWuxKBfRiDAkuyfLb9ejcxqPSCMDcGCyqG
# SIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM0dRAV2hBNm+CitpVmq4zFq9NGprU
# DHgoMA0GCSqGSIb3DQEBAQUABIICAJvmHvziCmVDKhT7287CYY9JhmNb3NPfQikE
# dtKr23gz+u4dcQu5pHoV8nPyWfUAMqG5QatHHBcyfKfnczbFiZdeyPAr52nUBGZX
# 76FnHp2DCJ1R91hJbZy+Jn9AtmoHIhPKWhMmWhpilaMn1wp0GcIjJgmrdcyPEQGV
# LvPd2p950HF2lTREqLrj30AI9CYYCZfUlbvR+p5U0kvovj5ZDYNjwjL19u2cMKxO
# DxV81TIfZ1ydGDQrruzkM61UNk65XnbQn5rTTYb9HWc+IvlKh/O0BiwtlBbIN7jE
# z5LkPA9rPGHPjj53KKg5Gz6YJub8WFgDrP74V9+ZsRD37cypsm3jwtVyTBZ1TeBf
# BK7+U506XtMEY0W51dqEFWzoZ1LHqyY5pG6ubSXfOCMdKA3J1FHq7QJUuHEBHaZH
# 1fggibBN7QVGRGBa/FEL/9KWH59E/HIn/+0uOhgo8/RR/EXdJtBe3YuJroK/vXku
# uAqS7coCIfRXzKMm2x6ogbFE8cEW9P6hg/ZS+9oL51FxJj00xA16gxyAU1u5C0CI
# 5xlf0ztJUK0PGe8E42xM9BNNDAHG7f1aNA8uztXv2isnne0TGfsJs1SZ9+s1A7el
# Rx8FtDc438ClrDM09kMZT4xbIz3L0stBiq9DKwI69ey+Tylw7I2MFrvfR2/nPb+L
# GGkYGccv
