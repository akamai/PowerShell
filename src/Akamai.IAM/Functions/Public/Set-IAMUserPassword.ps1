function Set-IAMUserPassword {
    [CmdletBinding(DefaultParameterSetName = 'others')]
    Param(
        [Parameter(ParameterSetName = 'others', Mandatory)]
        [string]
        $UIIdentityID,

        [Parameter(ParameterSetName = 'my', Mandatory)]
        [securestring]
        $CurrentPassword,
    ...
    if ($PSCmdlet.ParameterSetName -eq 'my') {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCX/QbnDbFEIieZ
# 3KFBWvaa2uVaW9I3+ueG2CGhPA3Iw6CCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgwa4kGFHiElfefarO7t2UsmA/SEYOCqIQe9quPOvENMgw
# DQYJKoZIhvcNAQEBBQAEggIAv/un+h8JGJPNdz0+NNkAsXHJ1f1EKOGmIFEcvpOh
# 9bLhPkYltRZkbCinH8nKGH6I8NNzZTMRgJWV5Dmy1JJk7dav+TrLrrwqwYTqRiDB
# SWr3mAA2huWTKY91bYyenr7AYXLARB0rn0y5GaCRPQNy+X/lTMdr8+fqguBpSQHd
# r0KvrnMtvtl8a2g3IpBLEK1+85U73ZUsxqWn5fooJtCF+APMRPw0BGAO+noTaEe6
# uM3CzTSm+UnCWBT0aeJK9oa4Ia4JLaHZA0kyOR+ku9qtcRLVYZ/yOZzMfdzviyUO
# xSbegGi6d0VIhR+tzy1MUea10rUgSff8XeyPHsQvcacodd8LaT0a484n30n685T2
# 1DU9pRi5xzV61Dq53xfwPc3/8+sXJ4EYBRb8uq5jEwP2DnepyxL+KTLBRAp4x43j
# JrLHNbQe3Y3IjRm53wxGuNqA683NqUmqzc0Uezf7C1W0VizLjZjtasgqcvTAuoeM
# 3eEM2q0L6k5z+uXad5/bwb+9Ov6C47tMIef7P1wJicLo0S6a9g0l3sN4CbUB6MDZ
# pm6V9FYHCoPe3atRapMPCH6E4rHLWpLQWi3RPA/vgow7KwmQqhS0VmHysr77EtYD
# kNGLgKB+dMBvh5InM1VULUxqKfwKA6drVGsKmiyeK/Pbp9Voo3V5OeQ9zSef8qkp
# S9Shghd3MIIXcwYKKwYBBAGCNwMDATGCF2MwghdfBgkqhkiG9w0BBwKgghdQMIIX
# TAIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEEoGkEZzBlAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQg4vTcsN36B9xn//rW9d/2/uftEirH
# IuJOwGWgfg48az0CEQDMfJ6n/wkkZVXL0KhLoEZcGA8yMDI1MTExNDAwMjMxMFqg
...
# hvcNAQkDMQ0GCyqGSIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yNTExMTQwMDIz
# MTBaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFN1iMKyGCi0wa9o4sWh5UjAH+0F+
# MC8GCSqGSIb3DQEJBDEiBCBAFc0MIqPBkz7d9o/5O/2Hx3D6KK9vw1H/aF9koH+F
# UzA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBKoD+iLNdchMVck4+CjmdrnK7Ksz/j
# bSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASCAgDENA3tOG+QSjc9U9ma8wwXG/VC
# PobWIy0oAaV5CSkdhNXo48xeZv/3DOZ7wWtzPYe8dl/1TzX8iQ+mLHnwr3eI1wP+
# cGLN3TB+rWPaQKaxhw0BljE1Ct/WlxXtS/qtigvc84i27JXTQo9b2G7oz6WE9qa1
# p+RPE//2t9UXcoqIYolt2nKYw2M1X8NzbAC7n9DMn8y0uKBaBBA0eoK5LCu7mI+A
# zF2ymYiqgEiNubMu9uads25g5H/ukgVfE3zt4b7j5o+7YX4A6rmRLMR+DGvghNWO
# 41wT0Xf9LC3/ZXHT9aHAHjoTAke9mHB5YfhX5GqBtGOOgJJkDCapegKeTgoFPVoK
# o+olpOdRw99ENilbKgBVftPP9SxIUK1S/SiU5AM6alCCCu0iRjxeLoU0q9UFqSrl
# 4dLSFzPvREa56Yb3BSUX8oUTNV+/jb95Fln7qSUxsUqptaGcco8HhbIKeafEbMST
# uLb8tE2ntO7SxTV/OZs71EH6g1Zf3Gjbk3A+hYtv/zMS+8y3Pt5u8FO8NK08Rubn
# ikyKVW6vj2EfxA7tQMiuUrpUvM2U9zSNH0adrd4lo8X50C0QteImBHJSPB36MDhB
# uD+50tH83iFnZ7iuiP+BixDbf8VOEpBag+45/899FOPs7H61cSDGqEWZV5wyFPBE
# Uano2BcaDLWZT2iDQA==
