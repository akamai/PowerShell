function Clear-AkamaiCache {
    ...
    Param(
        ...
        [Parameter(ParameterSetName = 'cpcode', Mandatory)]
        [string]
        $CPCodes,
    ...
    if ($AccountSwitchKey) {
        Write-Warning "The FastPurge API currently does not support Account Switching."
        return
    }
    ...
    elseif ($PSCmdlet.ParameterSetName -eq 'cpcode') {
    ...
    $Path = "/ccu/v3/$($Method.ToLower())/$($PSCmdlet.ParameterSetName)/$($Network.ToLower())"
    $RequestParams = @{
        'Path'             = $Path
        'Method'           = 'POST'
        'Body'             = $Body
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAUOwMwh+77nVJz
# 97paB27mC8WXkFU0h91udi+M98a1LKCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgxzro1LTLgeXp8UcF5IbcSlGmE2PkVts1XgCCmotKqggw
# DQYJKoZIhvcNAQEBBQAEggIAaA7ZOUn/N0B/xk+uo/KenZLgaC1XM5JP8f7UZYHY
# iZRbiwAK9IBkd0kb1N5KUf/nxbLvixIItesuwWLGU9SY2MfqEvO0+G2MaZFXpzw3
# iHNgw6zRsag8im6MvcH7ONVR/zExtLult8sV01fRoEqENsUXHlotqyQQ+w1dt3Dw
# 71UonaO4DSab3C5EVnkCq9i9BBml6JMOGdY8Qj4M0ZdcommUrkBuwBBedg1cwj8J
# 3mK+rZy2jqXHv9H0jPhaM+wPUyLTnhbthsOTLZLJfrigIDZlCuHUQV72MeFeOlvo
# nbRIYISA+J5Z7HwCheVG3nSFbKTWQ2rN1ZY4XZ9NYDFOpbP1RkdNC5OpsDZw4WHL
# E+tpflz0ycG1hk2qSFltrp8/vudK5RAqdcXJkY3t8l5FAxDgJfKwPrBCh3NkNdjo
# 6artCNUgcpXVmVyxxNILots/ZJ5NGimUfeuZ+Lc/HJTbdP8MVQrVI8sskPycHn89
# kZYimvHmzLnBDid7a9VYm9NcW5tr1Xx/QGKa1BvYft3TTX4Lmd3wfxIPtdKesttC
# W2ASyWRGaHBznnHZhimlnq2p6XsoO5pSl+c9bQoPxllNUgT8A+zg45hH3nwMe5ar
# oIxkYMf/Wpw5BVsZT8KtK6ZnLj3OtZ742QlszUJ/cRpaVWzdI38MY1E4n7IpyNRF
# k56hghd3MIIXcwYKKwYBBAGCNwMDATGCF2MwghdfBgkqhkiG9w0BBwKgghdQMIIX
# TAIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEEoGkEZzBlAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgUc8Vrhi3LWpQ89cw65m7nqALQAQK
# NEg2q9ksfW034M8CEQCe+EcNTchgvJQRpkmuVUYyGA8yMDI1MDgwNTE3NTYwOVqg
...
# MC8GCSqGSIb3DQEJBDEiBCAVQoFzz2EP4CJBgp4U0xf3q++scVizYJpBZ5XBRNHh
# TDA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBKoD+iLNdchMVck4+CjmdrnK7Ksz/j
# bSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASCAgB6S1UcITPeAZFBNl9e1QoEO9mi
# +XwiH2SXWcQ4LTFCqkrQmVF6k3WhJ0PkLjHZFAJ6/KLsKQbO/RnSScVSj6Dropfx
# wGJ09WsA+IIRM+fSimMWKrIrxZmTxdHxLnu+m/47RLiFEqCAqirKDHbGtqhA9/+R
# maCz7FB9SJhdQpDeNOE6rwRWULgC6y+4kRucYU05FAYSuC4lPgW8MnrBSxw1VZlL
# hMpOZtr8sZBaF43g7uSVfpSht6p8bRGq4p+asgXKeYR4WxaUwnes0YOyHjfTzoxu
# e8rPMbRX+j9utDIqC0Woci0uRSXZfNpgshFB42cMvbTtNYICvYgzEy2FJwacr44q
# kvYL07gDY5pnjLFZJ76vI6BDZsIlSxgBPOrhA0HppNJT6Zh6g4vLDftOv4CNm+be
# xIoYw5OhmCpVXFDPHoz1hs/KxUx0zGGEDd2EA4aTjeQpAmlybJTRFZeIdTwIKqJM
# 5sHZxtIM7oZCi72h+H0ZNDuGEek8Ne0iO0wikzK0SMuCNH+GINf0pkdageFXGzuU
# 3UuWaq7TuYTyE/yvEjbdBsxaaTZOycSKIzudhkI7Dtl3ePRkWOnBRh7eUHQ2cKgG
# 4YVS7Zs28eBnWk7V8bsdpCJtcaqwoJ0NBvCsOQ6Pq4SWEFPUMdKGLtPymFtmeWLE
# 4bI9cilGeg76dRZG5Q==
