function Expand-EdgeWorkerDetails {
    ...
    if ($EdgeWorkerName) {
        try {
            $EdgeWorker = (Get-EdgeWorker -EdgeRCFile $EdgeRCFile -Section $Section -AccountSwitchKey $AccountSwitchKey) | Where-Object name -eq $EdgeWorkerName
    ...
    if ($Version.ToLower() -eq "latest") {
        try {
            $Versions = Get-EdgeWorkerVersion -EdgeWorkerID $EdgeWorkerID -EdgeRCFile $EdgeRCFile -Section $Section -AccountSwitchKey $AccountSwitchKey | Sort-Object -Property sequenceNumber -Descending
    ...
    if ($ActivationID.ToLower() -eq "latest") {
        try {
            $Activations = Get-EdgeWorkerActivation -EdgeWorkerID $EdgeWorkerID -EdgeRCFile $EdgeRCFile -Section $Section -AccountSwitchKey $AccountSwitchKey
    ...
    if ($DeactivationID.ToLower() -eq "latest") {
        try {
            $Deactivations = Get-EdgeWorkerDeactivation -EdgeWorkerID $EdgeWorkerID -EdgeRCFile $EdgeRCFile -Section $Section -AccountSwitchKey $AccountSwitchKey
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDxXXacOL4twi3P
# VFm9Swh6UxaC+DVUF+vSF5yfwTHPV6CCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQg/Zb5/Yh9jm0E5uE5bIl0AWuIor0MkL0/G9iar5pRLvow
# DQYJKoZIhvcNAQEBBQAEggIAn2UaTlenUudCSyPIeo6TQzIp7PNx4Lo37LOVExJK
# Qpwt0kPogNzn0JxOX4BnmlF2kluCCX22x7IJ68oTEjycp/ZQPHpaG8KWUaozRo3h
# EDcVayUfCwEQY6CzHWtR3BtnPBLdWbBPKOVtLPqIpIldYIQTspLn6PNAlvNSMUWQ
# erk9dIfstxgYMHk0bT8FDG6NFLwLJEQdI/d8r2PtHBr3lAUrHBcZE/MUS2urVUpu
# dq11o7EFqAPX9KAjLZRIvxpwZFnxS1lUUYgMbqeDhtdLbPwocx6fxAxkGAaYOG9M
# 1DCuGb0Xj235PoENoqJyKJUJFHIjdn/V2zBtPWDxqGawbN4CGNUYhYFGRrBBetVO
# AT0WJhRAxbCy+4eGKkbYK6e27iFruYp5z6kOinJhbh1064cFnLC3sz4Yj7jqnvYI
# lnJu1kajigXlPnUUQBk5ce7hA7dvG+NmuiSQXrZZzy+U0wQuYlVn01F3fA9JLfoT
# huVeD3mHxtSbdr1LTAQfKYBMQWxRhqqSqh5EyIsxaUrndaKikIv15qHEM8C7K3P4
# Pzq7EYB6GvK+WJW3SO081m+TJVA2S3seRX1dTAmaGFJUVTx/KmSyXu0HvPq0B9rf
# CalnZ68DqwLQ01fuB8o63NszNGNqCN62xjg1DZ+AH28myBHzGL2rbU6mWEcbLIhz
# uqihghdAMIIXPAYKKwYBBAGCNwMDATGCFywwghcoBgkqhkiG9w0BBwKgghcZMIIX
# FQIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEEoGkEZzBlAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgMo3UIZoJxY35uvLVD2NIfxYA480l
# 7tndRZimA31U1qQCEQD0LcrbOdqmXr8CzJM24X+TGA8yMDI0MDgxNTE3NDQ1NVqg
...
# DQYLKoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI0MDgxNTE3NDQ1NVowKwYL
# KoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLCyQ+CXc6qisnGTxmcz0AwLwYJKoZI
# hvcNAQkEMSIEIEKwr87+2+hwsJpjjKlqVfN3u+OsqIp6rJL3zMve4GaHMDcGCyqG
# SIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM0dRAV2hBNm+CitpVmq4zFq9NGprU
# DHgoMA0GCSqGSIb3DQEBAQUABIICACT98e74kkC7PW4CdR/EaKyIKrYbIoLc9aUJ
# 09N/CTPIFty2V7uN/97Xppam7tTM31Ne9Sdyo3MOhnjPw+EDDLBoWaP/QFpgFIwf
# pW3r3pba5VVJY0Q7HR2Nr8jh5HfvTOq3iyH8kbh8XsARviyKfUNf4myvpxmVDJ0y
# jCMalOHKdfCOnXvJFh7Cd3gaOdxG/rRcNCEPCMbWQB/qgIO1lnaHonvj0zd8AKRC
# QU8LhBWIKg4thDqwwNhN5f9PD0LiFOrdjkL8LV/QxZGN1KiAMnt5A4olYa8dOtSw
# N8eQTmbG22JV1J1+sjyeYmI4RQxRgcQU21eMXkWBF2csPJimShlYBhlLUA+1pppr
# Jh2sEpHBv5ss1KXSfv3Vifmtwv+XMH56YMSj3P1sXXF3snXI9h8dj1ciLe7e3wxE
# XVoy5RbbavC+GFZD/gl2dwNdLwnl63NMpiys2oDbDv4IcEpLdRKMJEB9AKOXk9gw
# 7qMaMJZUWiOLIOPbnI7ZBhcxNecNtJOd7Od0CG3K7Cui5XCAODtJmEQ6p1odKXTY
# FEXvKQ3n2bhDyN6eAu3SGv5RLiUPqeBFEf+XLpnbMif2JZSRUGyBODhQkxShR7EJ
# wtVkjOcqgB8VBeuJKz/gaWA4+vnsE90MKHSEE+67VByoMZj8bBh/Glb5Yy6tuUhe
# dP1O4h3l
