function Get-EdgeWorker {
    ...
    $Path = "/edgeworkers/v1/ids/$($PSBoundParameters.EdgeWorkerID)"
    $QueryParameters = @{
    ...
    try {
        ...
        elseif ($PSCmdlet.ParameterSetName -eq 'name') {
            return $Result.edgeworkerIds | Where-Object name -eq $EdgeWorkerName
        }
        else {
            return $Result
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAMoFhOKSMjHpyz
# 69YturNNilHOZAxzuio9mLkvXr9i7aCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgRxqsR2rrbmJU9BS9CPcoy2A5lh1er7cBfIeTlq8dLAQw
# DQYJKoZIhvcNAQEBBQAEggIAVwajx6YwQFz3BqcoCmGKMi+y4U6+vs5q4yOV0Nwd
# gsygv+4FE67XhO0KS2BxB/JpvOgI4BqlUOLwFCkDohw4p25NSzfPhV9OaM6h13n6
# kS5qoFAVFp+RvSakzAfwUHlku01l+gjbs+b607Uw/XEoNIEah9FcN4Q+SAKzAIUo
# TKCgjlxcngNn+bwBdXa3nyf2BWFZ39/bzwnrQ0APp4UxH7SdrwfY7m856X6m25Xl
# UM4NTdkpxk7AVxML0BbYfxFjft/PNrTdsjvXsufDFyfVT+UVyIWAIv0kCq41PBrp
# YLuwutAZ3KwQy5T9K6tCd/23WvHqccK7CiMFbEs7BJ/KNpv1LodcCPFD3XsaXzlm
# opoqN+k6MkvT0eRlNPSkP6Q7oSwDUAZPzvII/wmaSy0keDQrC/FEsqtpHgPItVGb
# UXW2a87vdz2EJYqhJgScCaCktIaFd1DuOyNABPDO0MYHrqPaPXjhQNpgcoBLTRpS
# 1s9igzXfwSDnD4BOuEPO+xn8XizxVzR6mGuiwbCzc0tGfAFa85H/V+x7VKcAUroy
# trjqTU4jLy/LtCeQzKbjnKAiltgrh+7VcmbfkxhogkyUtzN2Qz8OriFSKrH2RJD7
# dok0r875XasKxfs/0DqYBKFMiAfXDFTnwVQf5vckGyoFzVq5BuWAzjMwQNqDelQj
# I1Whghc/MIIXOwYKKwYBBAGCNwMDATGCFyswghcnBgkqhkiG9w0BBwKgghcYMIIX
# FAIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEEoGgEZjBkAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQggOOtFoPxZGhjWOjhmaeB+CXAA5ml
# 7fGPvYs5KFDccbwCEA8RNvlpRsi1B2GhipygoW4YDzIwMjQwNDExMTU1NzAwWqCC
...
# BgsqhkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjQwNDExMTU1NzAwWjArBgsq
# hkiG9w0BCRACDDEcMBowGDAWBBRm8CsywsLJD4JdzqqKycZPGZzPQDAvBgkqhkiG
# 9w0BCQQxIgQgpKlMkvgSm17F0fwGI/Ue3vXGsiaWULB/kOB4tdyvCQYwNwYLKoZI
# hvcNAQkQAi8xKDAmMCQwIgQg0vbkbe10IszR1EBXaEE2b4KK2lWarjMWr00amtQM
# eCgwDQYJKoZIhvcNAQEBBQAEggIAlFVAlUb3gCl9CrlSeaNjUMxFZbBUraeBvuH7
# F27imfwRYV2cVVQZe9MN9k06eKz8h8lEYQuAVM0MrLacn1TLtA3CiZtqRcgZeSeI
# SGTIieqvdfpsFMLIm/jpKGVZeAK9RlU/TfxtKY3Kvx7ov83vKOsPxEBzcEnaaeF7
# IdUcAeTU66mRyxLahkcrULfw8Yv7zjrrYCvHp9T8gKXzA5A7/C9BWV3oJ8UX8XYk
# FIEjSkmKWlNHt9KfT90M6ajGi6KeN0AmnaCGPPbFTUncySoz8had0+dwzIt5A6P0
# wkJmFV+Ot0tG/xdCow0zLmjCvoiJsiSI8WvA3glZZoo9z5Wza8UAgGTCsoz9//eH
# y+HSr93dSRUsY3uO1vr+mI6ITXJcgj4QOTBqWPUeXTTY7jt0eqcr9rc7OR7Pd/Rc
# JLbcyfY62ULVeXROT8rVs94k1PiA95x4iKV4oTWI3nL9F5FwuhB21SiH0HAy/e1o
# 0e/IhUv5+0Gfs8eKcI51Y+u6W4k71BNSH+BAFj1SmB1zo6B7UlCP8zse/tcOSNIz
# 57917fMhwI6bqZGPyGbsJMEkMehedtrLzKgagHHdGm8MGvEi3bmN+rnzT14F0XxT
# nasb0+uOYDTVmuw6HFZpOijQDX1A/2g6IFggaIMJ2KYKGbhqCIXBGR8KcfKjB8Qg
# fhsqLpw=
