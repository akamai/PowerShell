#
# Module manifest for module 'Akamai.EdgeWorkers'
#
...
RootModule = 'Akamai.EdgeWorkers.psm1'
...
GUID = 'a855693b-8d42-4bca-82f2-8a535c1170c6'
...
Description = 'Functions to manage the Akamai EdgeWorkers API.'
...
FunctionsToExport = 'Compare-EdgeworkerRevision', 'Copy-EdgeWorker', 'Get-EdgeWorker', 
               'Get-EdgeWorkerActivation', 'Get-EdgeWorkerCodeBundle', 
               'Get-EdgeWorkerContract', 'Get-EdgeWorkerDeactivation', 
               'Get-EdgeWorkerGroup', 'Get-EdgeWorkerLimit', 
               'Get-EdgeWorkerLoggingOverride', 'Get-EdgeWorkerProperties', 
               'Get-EdgeWorkerReport', 'Get-EdgeWorkerResourceTier', 
               'Get-EdgeworkerRevision', 'Get-EdgeworkerRevisionActivation', 
               'Get-EdgeworkerRevisionBom', 'Get-EdgeworkerRevisionCodeBundle', 
               'Get-EdgeWorkerVersion', 'New-EdgeWorker', 'New-EdgeWorkerActivation', 
               'New-EdgeWorkerAuthToken', 'New-EdgeWorkerDeactivation', 
               'New-EdgeWorkerLoggingOverride', 'New-EdgeworkerRevisionActivation', 
               'New-EdgeWorkerVersion', 'Remove-EdgeWorker', 
               'Remove-EdgeWorkerActivation', 'Remove-EdgeWorkerVersion', 
               'Set-EdgeWorker', 'Set-EdgeworkerRevision', 
               'Test-EdgeWorkerCodeBundle', 'Undo-EdgeWorkerActivation', 
               'Expand-EdgeWorkerDetails'
...
AliasesToExport = 'Deploy-EdgeWorker', 'Disable-EdgeWorker', 
               'Deploy-EdgeWorkerRevision'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA9fvW+iEhMfMdv
# MQvrfz0Ykob/sD+fg7OqpJqluQPM1KCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgZamXqSzavAny+zpRoy01HtD6rTa24wOUKgN/PgMuQ7kw
# DQYJKoZIhvcNAQEBBQAEggIArl2j2y+u+cJmq4UWQuPrD4yfFkl+ummlyeqksass
# plkO7d4dY3xA+c1T2sVTgOqVFnqwzl+dvnrHdNkLN3OxM8O9ef6dp8bnZcaMU/9p
# AnJNyiU5pXtwhx4E6lRbmYhxkQpTyvE2gWMC8+A2qBcBxh8txR6IOhWI0WE4295M
# efVGMbExo7lrEvcpmyHxdEiPq9AKpomCeXg8qwFTYAJyVzZxGIqLOkDrbD9YVvZn
# X5ceoMNyYiFusuYQC0rX9DDDvrIQWJ0etgOBQ/HX15/OP3vsxjg7p0OZMctrzE9k
