function Set-AppSecPolicyURLProtectionPolicy {
    ...
    process {
        ...
        $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/security-policies/$PolicyID/url-protections/$URLProtectionPolicyID"
        $Body = @{
            'action' = $Action
        }
        $RequestParams = @{
