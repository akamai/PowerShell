function Get-AppSecHostnameOverlap {
    ...
    process {
        ...
        $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/hostname-coverage/overlapping"
        $QueryParameters = @{
            'hostname' = $Hostname
        }
        $RequestParams = @{
        ...
        return $Response.Body.overLappingList
    }
}
