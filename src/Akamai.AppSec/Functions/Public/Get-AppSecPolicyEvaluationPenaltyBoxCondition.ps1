function Get-AppSecPolicyEvaluationPenaltyBoxCondition {
    ...
    process {
        ...
        $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/security-policies/$PolicyID/eval-penalty-box/conditions"
