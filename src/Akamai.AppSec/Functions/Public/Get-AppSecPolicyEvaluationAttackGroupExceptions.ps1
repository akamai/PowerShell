function Get-AppSecPolicyEvaluationAttackGroupExceptions {
    ...
    process {
        ...
        $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/security-policies/$PolicyID/eval-groups/$AttackGroupID/condition-exception"
        $RequestParams = @{
            'Path'             = $Path
            'Method'           = 'GET'
