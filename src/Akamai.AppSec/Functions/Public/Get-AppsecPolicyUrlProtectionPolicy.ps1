function Get-AppSecPolicyURLProtectionPolicy {
    ...
    process {
        ...
        $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/security-policies/$PolicyID/url-protections"
        $RequestParams = @{
            'Path'             = $Path
            'Method'           = 'GET'
        ...
        return $Response.Body.urlProtectionActions
    }
}
