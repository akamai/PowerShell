function Get-AppSecPolicyBehavioralDDOS {
    ...
    process {
        ...
        $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/security-policies/$PolicyID/behavioral-ddos"
        ...
        try {
            ...
            return $Response.Body.behavioralDdosActions
        }
        catch {
            throw $_
        }
