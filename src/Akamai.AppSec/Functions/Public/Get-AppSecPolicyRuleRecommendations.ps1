function Get-AppSecPolicyRuleRecommendations {
    ...
    process {
        ...
        $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/security-policies/$PolicyID/recommendations/rules/$RuleID"
        $RequestParams = @{
            'Path'             = $Path
            'Method'           = 'GET'
