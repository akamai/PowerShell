function Get-AppSecActivationHistory {
    ...
    Param(
        ...
        [Parameter(ParameterSetName = 'Config ID', Mandatory, ValueFromPipelineByPropertyName, ValueFromPipeline)]
        [Alias('id')]
        [int]
        $ConfigID,
    ...
    process {
        ...
        return $Response.Body.activationHistory
    }
}
