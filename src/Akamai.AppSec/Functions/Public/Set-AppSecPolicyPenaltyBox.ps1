function Set-AppSecPolicyPenaltyBox {
    [CmdletBinding(DefaultParameterSetName = 'configname-policyname-body')]
    Param(
        [Parameter(ParameterSetName = 'configname-policyname-attributes', Position = 0, Mandatory)]
        [Parameter(ParameterSetName = 'configname-policyname-body', Position = 0, Mandatory)]
        [Parameter(ParameterSetName = 'configname-policyid-attributes', Position = 0, Mandatory)]
        [Parameter(ParameterSetName = 'configname-policyid-body', Position = 0, Mandatory)]
        [string]
        $ConfigName,

        [Parameter(ParameterSetName = 'configid-policyname-attributes', Mandatory)]
        [Parameter(ParameterSetName = 'configid-policyname-body', Mandatory)]
        [Parameter(ParameterSetName = 'configid-policyid-attributes', Mandatory)]
        [Parameter(ParameterSetName = 'configid-policyid-body', Mandatory)]
        [int]
        $ConfigID,
        ...
        [Parameter(ParameterSetName = 'configname-policyname-body', Position = 2, Mandatory)]
        [Parameter(ParameterSetName = 'configid-policyname-attributes', Position = 2, Mandatory)]
        [Parameter(ParameterSetName = 'configid-policyname-body', Position = 2, Mandatory)]
        [string]
        $PolicyName,

        [Parameter(ParameterSetName = 'configname-policyid-attributes', Mandatory)]
        [Parameter(ParameterSetName = 'configname-policyid-body', Mandatory)]
        [Parameter(ParameterSetName = 'configid-policyid-attributes', Mandatory)]
        [Parameter(ParameterSetName = 'configid-policyid-body', Mandatory)]
        [string]
        $PolicyID,
        
        [Parameter(ParameterSetName = 'configname-policyname-attributes', Mandatory)]
        [Parameter(ParameterSetName = 'configname-policyid-attributes', Mandatory)]
        [Parameter(ParameterSetName = 'configid-policyname-attributes', Mandatory)]
        [Parameter(ParameterSetName = 'configid-policyid-attributes', Mandatory)]
        [string]
        ...
        [Parameter(ParameterSetName = 'configname-policyname-body', Mandatory, ValueFromPipeline)]
        [Parameter(ParameterSetName = 'configname-policyid-body', Mandatory, ValueFromPipeline)]
        [Parameter(ParameterSetName = 'configid-policyname-body', Mandatory, ValueFromPipeline)]
        [Parameter(ParameterSetName = 'configid-policyid-body', Mandatory, ValueFromPipeline)]
        $Body,
    ...
    process {
        ...
        $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/security-policies/$PolicyID/penalty-box"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBpOq0HUCVgvvYx
# PKJZTcKL1fku0lw50KHNRzZdyavcpqCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgJfmXGrwqvYkwigsF4X5/gJdsMtpTP5GLDC3aZ9p12mAw
# DQYJKoZIhvcNAQEBBQAEggIApN/8qEzIIwMNc0ubhoMG8a47CS6kA/HLzIRHAvPe
# 5yewLtzD273wJvfs+WF1U/m0CHlpXLuN9xz3p10KiNrY613ucQYweU6rWs6GYbgh
# Cka/jCffbLmgH8Xm/Q2/ENFAwztjtIijq8v1wqBPNx7LcFcnP/haf+GH2dv7a59O
# XAZfLQ5Hkm7vRD6jE4LSMJFPbNVR4qJNEOu6EKLdZ5MLaF0TJ/7y4KzvNajMN30i
# y6FxnpAeF5XMfMvBPnVscQfJ0qKhR+fa0AmP4eJcTHkKECEPfN0DQLCR2Rpq3a8+
# MeyLkBEQIfS8elwuRENa17unNWz8+sgneaizGdoEYIRgNPyw8/2gJ9EcgjJau/VD
# 1DlbNIrB1mzWHTKCGWZ6UIKo5QScAj4r6qj9344SJVpQikNZ1bf0bRJw4ECsao5h
# xWMxFWGGHMKCOtdBTlrSamvN+dmYFsyRMFtiEiQ6PAQ/ZduQY+C35WxLdyoL017h
# IE9YUkoyzIN2SWBOosutEt/99iP5VjnvWptnioqGeSXkalEvbp0U0Bu81jxGxxkI
# pgifPncbZ+duixvbKBxhxLw+938IKUOnt409OsNUbXQQF29NAfDp1VFF/AIfhiF3
# TPMD9FQsetQ7gYRbsP8TeCMwbD1rvILuoQBa5FgBhoXIyW5a/SvEObNWyWJD505B
# W0Ghghd3MIIXcwYKKwYBBAGCNwMDATGCF2MwghdfBgkqhkiG9w0BBwKgghdQMIIX
# TAIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEEoGkEZzBlAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgGV3WvBNE3eP3knEXGTf3p0Y7s6Qj
# F15QhWqLOWuZWHwCEQChiYYWBIA8E6aUfq3TDDRsGA8yMDI1MTExNDAwMTEyNFqg
...
# hvcNAQkDMQ0GCyqGSIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yNTExMTQwMDEx
# MjRaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFN1iMKyGCi0wa9o4sWh5UjAH+0F+
# MC8GCSqGSIb3DQEJBDEiBCAHtSZnJE9yM7DXhxbyw8jnYQAbANZe43zp/YA7tVa7
# NjA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBKoD+iLNdchMVck4+CjmdrnK7Ksz/j
# bSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASCAgAFyBJK8Bdf128ly2gQALOq1MYy
# TX+IfyF4ycYaHCh2ME5fBFue+UF82GvtU/5ik0UNLS4ko/fm0Foc2EWwccKhasbF
# Xv7rMKNvrY2a/zLw8maSU+pS50zu1E/DQDfRp07skihZk1SBz4gEZeBttzYBSZq7
# PGjI2vzPlb+BdysB63nSPXJ0F+OuztLxKR70LwuYLdocYoFaET9nCWVgf0HgbU2b
# J/0TWK8GVT3yiPk0eFh9JIz3+XqES04tAv8kv8ffhNbokNuuxg6A41luLlXp/CRP
# ygYImHhBVAtdL8S/SzrXMtghb6hDkig+5Sp1ekEjhrIX3jiSntzkNB2Y3mLNwZTX
# gAmUzzgSN4iAP9lGY1fkmMw7orbAE5Y50zue07oamphXE5x1Fguy1sfS9u+kjJ6q
# G32VgnnT2bSfQbJi31OO2klowMhvjIfQwdxgjJ6bsQeRqs+cxV2vNhKjNYnEu4mg
# RFdEBi3NbBZTDpneOfkT0Z/PwyYLbiCRVAgnRo/dqPx9mwUDGhb8FyAiGTH6F/Dn
# Js6WskQHmLzmfnVmbl83KnKPMnwdP2HEPxhePpsnFILkcNdGyrTI1wblLRsYueCI
# mXQWf2cwfG7SnwsRJZVxenBc/6MtNNkoRLMpjZKAYNljyc7ifUkx4zdcyalWaXM2
# dy6/C5MIb8/RbJ44Cw==
