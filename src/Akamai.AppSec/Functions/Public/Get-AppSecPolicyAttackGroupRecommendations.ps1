function Get-AppSecPolicyAttackGroupRecommendations {
    ...
    process {
        ...
        $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/security-policies/$PolicyID/recommendations/attack-groups/$AttackGroupID"
        $RequestParams = @{
            'Path'             = $Path
            'Method'           = 'GET'
