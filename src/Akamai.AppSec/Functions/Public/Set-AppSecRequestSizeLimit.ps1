function Set-AppSecRequestSizeLimit {
    ...
    Param(
        ...
        [ValidateSet('8', '16', '32', 'default')]
        [Alias('requestBodyInspectionLimitInKB')]
        [string]
        $RequestSizeLimit,
    ...
    process {
        ...
        $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/advanced-settings/request-body"
        $Body = @{
