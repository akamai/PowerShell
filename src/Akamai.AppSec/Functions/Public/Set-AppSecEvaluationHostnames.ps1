...
function Set-AppSecEvaluationHostnames {
    [CmdletBinding(DefaultParameterSetName = 'configname-pipeline')]
    Param(
        [Parameter(ParameterSetName = 'configname-attributes', Position = 0, Mandatory)]
        [Parameter(ParameterSetName = 'configname-pipeline', Position = 0, Mandatory)]
        [string]
        $ConfigName,

        [Parameter(ParameterSetName = 'configid-attributes', Mandatory)]
        [Parameter(ParameterSetName = 'configid-pipeline', Mandatory)]
        [int]
        $ConfigID,
        ...
        [Parameter(Mandatory, ParameterSetName = 'configname-attributes')]
        [Parameter(Mandatory, ParameterSetName = 'configid-attributes')]
        $Hostnames,
        ...
        [Parameter(Mandatory, ValueFromPipeline, ParameterSetName = 'configname-pipeline')]
        [Parameter(Mandatory, ValueFromPipeline, ParameterSetName = 'configid-pipeline')]
        $Body,
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBzi1CVzcoj6TlM
# NovBmXw3XrnC56hoQJm4j31msBKGlKCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgt/j9pEN/ltS83P+H8ZmdzXLrvTm6Hd8MIRs5DPTe0eIw
# DQYJKoZIhvcNAQEBBQAEggIANJUT54CPBlm2KoBPPat+7lYGlEatsRA15J8j219U
# XkZdPJqCD3slLyCvn087bGQQut2Xy48k+CZUbeiwgCwt1s+Z0/I45+gZr0LIwrqv
# kX1TdJ9Mw64icZ2FmC0CS7JBXGtut7XJiKc5u4g8rROccrf/AqqYVQG6hmcrhiAO
# t+HbX17pizQYcPRE5MY4oNkYBTIvNZ0dqsvUTQijL13mdwRF8nYavbEkrokDWMLa
# j4hNZ7dTLcHLCWN0hJ54xxEGZbon04SPavNO2mutHTfAlPbJ7vC6dJka3s2SLpiM
# ZdWGiAsKcsWGGjAQEadMhrf9/wRmZsz5yGYwubwsVF6hIQ0IyKWWfEYaGj7vy3Yy
# Uzrrq2WYH7NqRuBowm6haU+6ghBQseLSx3QlfjECBSs5dA1GijP7wt9f5gLnetU7
# fT56YjdMM1QebRhl34a7mF+VglZGPjYh7CTUSyaFcr1TwVW+qYX5iJ3oxt2QNp0a
# 20jisVlqGqX3RJqcKvyA3uYVxIaHiOZ9fRh2knKovo9bZdlht4pnsYFfbrj+oZyE
# jWvdTLikCMBXquyjFwsXy3t3rELBnxWWaQU1WFoG9it0lhW7gqK9VCt68mq+qmGE
# ky96f+JdWSDL3ZGnr77qH+h/4NnUDW4jBnKc7KJdaHjrKORkDWNfyzKZb0hu6pO1
# y2ihghd3MIIXcwYKKwYBBAGCNwMDATGCF2MwghdfBgkqhkiG9w0BBwKgghdQMIIX
# TAIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEEoGkEZzBlAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgpFYOYFnzV16bhlHDZ1DIXuNqcyjh
# UUAfa7P3Yw+YbYcCEQCp7GQMNagC3kEFWBKLYxcnGA8yMDI1MTExNDAwMDMzNFqg
...
# hvcNAQkDMQ0GCyqGSIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yNTExMTQwMDAz
# MzRaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFN1iMKyGCi0wa9o4sWh5UjAH+0F+
# MC8GCSqGSIb3DQEJBDEiBCCmzdxQFiyMgEe9fh7OQkPp0FXr5tkdVd6mf8lFJdTh
# tzA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBKoD+iLNdchMVck4+CjmdrnK7Ksz/j
# bSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASCAgAm5BoxTFrfd50JrHDRB6HGgPBm
# ATXu4ABa8FxCqg0isDqNRIl07/0iTPW7EVDShaTN18ZFMNR3sVAcoxZQQ/aXi3Mc
# mDJm1wtLTXfn0C5ZRT3SyqL+Fq+ycTmNF1HnhG8Xyau83yfri5gApDucsmodwolx
# 2/SGd3GeNnk5wZt7++2G1ssTmQDPB2B12+EP4dpjFCMKS3PhiR1SPTxOQ8VmkOdA
# cw3UD6YXlvepxijgK2xQ//G+Z4fv7lVjEZz2Ia9MxXjMpHkSxhlIco94GQ8liOg5
# F+VJVQiHOMN103K8UVuRcRGqtSZsG7tCjG03ftCCFUYn3KO025EJEFI4SZux2VbF
# eOZu9n1en1iCArJ0nxACeEJ2kjk6PBsT37a6xoSSQAsztV3KXCJCvLvevXSTySWt
# 8XQZZb1+nMtTw2vJAuKMAdnPF3T4aLDFazpwT3EK0g9JjprsoHuswF+9Mx34JSZP
# 93RUUIdL+Pq8bci7GjRTNuMImU1cZcyk1oAOt3LGpirbdbquckElspYVLuF1aX+8
# Ao0pHYTfWC7jDH9I7xNRChf2fNY/+bgV8gYY3AADCblYhQ0C9gNg3lSLofS/5mEK
# HK9jITVCpCDMeBZ7JqF55gALIUpvTI7vkqLxpFKSeyUOGnsmVDL+ejWBQ5Ke/HcS
# rx4hz8/TVRbM6aAKjA==
