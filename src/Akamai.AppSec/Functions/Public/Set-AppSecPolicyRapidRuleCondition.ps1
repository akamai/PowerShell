function Set-AppSecPolicyRapidRuleCondition {
    ...
    process {
        ...
        $Path = "/appsec/v1/configs/$ConfigID/versions/$VersionNumber/security-policies/$PolicyID/rapid-rules/$RuleID/condition-exception"
