function Get-AppSecPolicy {
    [CmdletBinding(DefaultParameterSetName = 'configname-all')]
    Param(
        [Parameter(ParameterSetName = 'configname-policyname', Mandatory)]
        [Parameter(ParameterSetName = 'configname-policyid', Mandatory)]
        [Parameter(ParameterSetName = 'configname-all')]
        [string]
        $ConfigName,

        [Parameter(ParameterSetName = 'configid-policyname', Mandatory)]
        [Parameter(ParameterSetName = 'configid-policyid', Mandatory)]
        [Parameter(ParameterSetName = 'configid-all')]
        [int]
        $ConfigID,
    ...
    # Add to data cache
    if ($Response.Status -lt 300 -and $AkamaiOptions.EnableDataCache -and $ConfigName) {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBsLs8n+Mli00+T
# MuytUYRnrjTEXxKNWtjZK6BoTB5CkKCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQg286iPbUSJBRtsfC82bx5ad/Jocx4mmTXaixT9syjv6Yw
# DQYJKoZIhvcNAQEBBQAEggIAsdB3WHs3IkxXC97ptP7amRl3ERH6vJYac2xFXOnA
# kabKTLfo04K9Nn2RgnDQySh/rFrQbBGOw8tF3dYrPYs9YSM9b/biCC0StjEt1Rw/
# 4nB880n77OhzPt2i1pIiIgYVdVzvdhE6wA1TwPS1WcAHFTMP6JObUVtkLTUNqEpK
# SEXUPvlMfprN5MQAaxXNcFjxmJ/fkLFegkWAnZ2VvwXme4VvBN+/fQiTQ/z70+hz
# YKdMYRGlWxd8Uu75C/G7fvDlkFgoZ+r4z4Z7S66fV0H1VpMJkmE7x5fV/vy7BZ9h
# AY/v60u79sHvoqCIgPPvR/dvUgVFsVMLdc+TEcw3tXErIe1352+bYzgRUQ1u3XO9
# a4mLhe+DyyPyrlF6JAmYNFPPn4nIIz6ULGsZXXFVudey6tXCvUsrUeKu1MtlyBp3
# GA3xzI6iiXX6JnE6jD9NYJfTr81vcFgcvNN+0hc11FrCSNsVP2n/UdsgGUnKBZwD
# LoT4DhOpK8EBnpsK6LPaT756vQ5i3gdc3CffwhGXJ2l9Voi8peflghebNaxxREoE
# FnabOMV7OeR38II3iv5rUzI2TLAXfzBDmdEzKr0oLepYG8txIWVaC1OcQre0Mxj0
# wDlJMtvK1juUMjbEEqZBnD57CPwhELTuQ333S9A3ZwwCCHA9IH13+Wwf+ZJHhG+o
# Il+hghd3MIIXcwYKKwYBBAGCNwMDATGCF2MwghdfBgkqhkiG9w0BBwKgghdQMIIX
# TAIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEEoGkEZzBlAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgC5G6reItdUSqsHqyZYegjTDKaIW9
# Kuuea1/4sYlsrCACEQCGfn64U14gJO7KmUJVI5ZLGA8yMDI1MTExNDAwMDEzNFqg
...
# hvcNAQkDMQ0GCyqGSIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yNTExMTQwMDAx
# MzRaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFN1iMKyGCi0wa9o4sWh5UjAH+0F+
# MC8GCSqGSIb3DQEJBDEiBCBiKdJ3NeM+m9mSAojfvv7SBNbUj1qm4f7liUzxflW3
# RzA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBKoD+iLNdchMVck4+CjmdrnK7Ksz/j
# bSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASCAgBh93snnq6Hs3s+qhgzmjhaCyXf
# Udwb7oE5Rv/ewhpUl6FQig6GfFguB7godOkyh8oqlVXmdKFAU4SBLUqLn59hc5Qi
# xqOGBuFD5h9koCrbVajwJ6YDzbKxTH9u2jCFhx02nv9URH7jb3co52HLYytxV207
# Nb2Dlg5po22mxLdBbORH7biQcqcl4IKRhIO4MVDxU2lUtZb6kcyQP/dN5zjy+fmw
# q79pzzD5lutVikTZpl+Sl+TT8cK1o+NvR2h+MwmSfbHyP+k0kNPW4NWoo7FTMlSk
# NQh6GNlLYcQIB/KV+7Y3XDwXgc3ZhipfqiDVP41oPJNWAy3z3GemhEQxVehDVKj5
# k1BgDmFEOnRKXRhifP2clOzqMgVLDexZqREF0DAvEAuxJTeLUoQVzc0Pi8bFJMSH
# GpcJdEu7VFs3bTSUjmj7oCMzajdbHvkFggxn56Ge3KT05mxECJMznEH51aiT2VQP
# ucDqB/WaXSxcS/YPuCD4xQ+8Q/TeOknVWV9s8EBqD+ja8WRBKXTi1JjpohuT7QBm
# 1kcbNkBNMNp/rC9mJaS6uhnhpxPWjtXlRAxlsgPIDl3S/11iA3Zp2RaMkWc1KLvA
# 7t08ffChNxCvJUBLIViIaAq+q9uDCXaoo2i+BTvDBK7WY5Kj00NUaQ2OkLTWSrD6
# ivC5gyIzp9HqufoHHQ==
