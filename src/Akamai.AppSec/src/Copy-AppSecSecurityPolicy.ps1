function Copy-AppSecSecurityPolicy {
    [CmdletBinding(DefaultParameterSetName = 'configname-attributes')]
    Param(
        [Parameter(ParameterSetName = 'configname-attributes', Mandatory)]
        [Parameter(ParameterSetName = 'configname-body', Mandatory)]
        [string]
        $ConfigName,

        [Parameter(ParameterSetName = 'configid-attributes', Mandatory)]
        [Parameter(ParameterSetName = 'configid-body', Mandatory)]
        [int]
        $ConfigID,
        ...
        [Parameter(ParameterSetName = 'configname-body', Mandatory,ValueFromPipeline)]
        [Parameter(ParameterSetName = 'configid-body', Mandatory,ValueFromPipeline)]
        $Body,
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDm0Iyi3KBbwygp
# Z3guQsIobPrRBhfYh5ZosblgSAneB6CCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgAHEWArLI6TaGt4nfnuksHccGxi23dENLN9N+aYDp+7Ew
# DQYJKoZIhvcNAQEBBQAEggIAYFRtJDQ9Fdf2De8Z84C75nxMft6DD5gaqeJDucjT
# Tm4PerrFQauJBdxjSY152yGviGCJ23rFyJwkqMzUDrbrp73T844SmxAuCavDyITg
# 2NMvSGk5LhHg/55n82F7dyKtPzjMwbnk1slFTyz+rrEvC7kRBhwtf8oqs5Sluy3t
# aWnKD9GGBcn34KxZIaBoDCgQpwuGQDetAZmvIxPZ386NeEzZeKdK4ps20qZGYHNI
# V0sOsl6MS576K3xerw0DTfIJuD1dRwa8eCrw2AH8rXxeVdpWTlga/3JIYu9/dJlz
# UvrqZu8UFUdLU60pzVg7l3aaTxdcY9ysK6N4sFfJ5AUvcg6m2NgoE4jgiec3RvnM
# XYyMsh6Zb017uvQFHfY+/SqMt8FpbWpVaHQ15s7WDdMsPyZej6+VASAHbJ3ZVzKM
# Y6TNWrSwirZLyZbSDr2Xly2rM0iDgwbvimZjmand0Vh2D1VOiYcgUKl71uLwzoXu
# rHC9Sv5Hny4lQOt1YrvMjYVfwax2d4UIwuAsF5CmW56NqH6PloBJriRcqn4iSgmw
# C9ixHfYvkitvecWs2b4S5r1n4d/687RrRm+VQpGj7T+67Tkxnc3N3fFW1LdVMvYM
# DoV3U8/Y3qYRfmOsHKpx0C2zplPOEkQ1xGqA1CCeF+mPqF6b8fHRr0srFICpoTNg
# 4vChghdAMIIXPAYKKwYBBAGCNwMDATGCFywwghcoBgkqhkiG9w0BBwKgghcZMIIX
# FQIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEEoGkEZzBlAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgHxZg5CzYkkafEkHMnI4as0WcBloZ
# BMXfbajgX14aB9ICEQCId950ZQBhuJW/r2Y2tHx+GA8yMDI0MDQxMTE0NTcwNFqg
...
# DQYLKoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI0MDQxMTE0NTcwNFowKwYL
# KoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLCyQ+CXc6qisnGTxmcz0AwLwYJKoZI
# hvcNAQkEMSIEIJkcE6pK4X/EtVbpDYu4M/JSngcTWjXrDIPYbWj25cuAMDcGCyqG
# SIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM0dRAV2hBNm+CitpVmq4zFq9NGprU
# DHgoMA0GCSqGSIb3DQEBAQUABIICAGr7zfwLLL6M/DJ38VdkIcRXUztVByER239q
# NE+3fZpCSI+O/tfbPDpXNAk4HwbHyhRnhUv4gpKI5Je7pu62VqLRgff07sam+4XZ
# 8hNsjWkopOIJvRpRK6ZNRZ9JPYrI8TRRQzRMznmu4dyH9xdNILctO7gOGHDRI9Lr
# vVOaJUPH9IwL8WpBUdtEKhcCTbE6nZmFxpA60EeEYW+b6u7TJxfFfvbfzfuGSS+8
# w5nC2HyhIPP2/1VPy9Dei0pv/Kv5+LnOW31YnbYMN9AtBYcWijo1wZn6MHpEfbI8
# 6OdTEXytbTiVw+1N1hfdrm8lAyHGFVxgz8jrVKJhgHbMIOxu7NGZckVqEjZgil0o
# t/F00UTrZmiLsn6tV/25+S+ybwAcQlgSnxDxxOGCVV5Bz1Ou/sBm7cj1bVTm6BIR
# 2nk5rri/3xjqutcyJIDAv/WfE6LbqFyKln1MwRPeQMWwzSW2upnL0uNzRYAipokw
# eTvDzJPXccPQ1+hP6bKgAOW/NrN3bw13FljaYL9VnMUXQZIafOrDi1QjDFREbVC0
# ZF5bwt73gdm8Nnlch1MfsZdgGVRv2HK/LF36H8yvgY36hx2SbUN1iWhqHdo63wPk
# oNIGesc+tp8mjjMozlr98Y09EZ/7ALIw2dsSKP4dEjIUSoeikQsLysB2OtsJncwu
# nMSo9ruO
