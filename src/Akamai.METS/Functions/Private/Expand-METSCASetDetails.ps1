function Expand-METSCASetDetails {
    ...
    if ($CASetName -ne '') {
        ...
        if (-not $CASetID) {
            ...
            $CASet = Get-METSCASet -CASetName $CASetName @CommonParams
            if ($null -eq $CASet) {
                throw "CA Set '$CASetName' not found"
            }
            elseif ($CASet.count -gt 1) {
                # Name match is not exact, so filter for exact name
                $CASet = $CASet | Where-Object { $_.caSetName -eq $CASetName -and $_.isDeleted -eq $false }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCASAK7J9m6Zpn02
# CNZnJtnDCOFcsfqhPvw3sbeDVp03MqCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgXO6twcdAOpQ14Or16MzH8eCbPVsX7ck5rEJ5Ee0sFYgw
# DQYJKoZIhvcNAQEBBQAEggIAH3V14sCQcjR6vzv49VAFBfIo/QJFyfoWsqLGvStf
# GDVeFXTK+i5bgub+DM8SGLo2ZLdWwL/7iSxIB7RdgjrUXxM6/7Y+LmUhVO9xRoi6
# Z2P5GOmAtOH5earknGTSOuVXqw5VN1MLOHeZolwbSCWy5ar5HOSFVh+L7z23VzbP
# KDP0hMc4dOO8/oL4PY+Tg6Lf0dzapDKs4Erlxrk+Fep9ecE9JMspJ3HeKjI3sKfe
# qkMWmQjUZxb1zkM/VQJeUok5zi3CphZk7Jbp7mGCRNV/swQEbqurDsuo+KBgSuQO
# o4iHY8R2Iqkq/74SW87QROA5EtYLvTeZ3Ki0Xh+o2V1cZ0XrxX5jD/p7MJkGNk3d
# aEvpR1FCMZEjp6fnA1Kgz5zqmr0tThDiaH0QcET1vlFk+8+zLo+Aj8qmQFFUFakn
# 2dWfx6AXumiy8fm5tA7qwqrmxDQQWl3odfpvfAeYBQzq6EXRWMeRd6Oo4LohWPsK
# N8lsHMHxb07ZcMosm1pa3j+my8taTwneF01AEMD79xDJCeNcV3XsfWUvrXs2gdsK
# uL5H3NzM1nRan6N4njT1ghNsXZdfj/mBbSbJr5NWgDPF0vReuNyjSRlioWxXvJbB
# eBxccrztAYIzxw7kVqIWqg4FIQxobAta9wvf84FpNwifx1giPkef6uOKxH3MyewR
# UYyhghd2MIIXcgYKKwYBBAGCNwMDATGCF2IwghdeBgkqhkiG9w0BBwKgghdPMIIX
# SwIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEEoGgEZjBkAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgswBU6Oj+HUbfGfQofFtInGhczFpV
# iONhyxR55aQEyHACEAew1CaPgxd71YstDO0EInQYDzIwMjUwODA1MTgwMjIyWqCC
...
# 9w0BCQMxDQYLKoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI1MDgwNTE4MDIy
# MlowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQU3WIwrIYKLTBr2jixaHlSMAf7QX4w
# LwYJKoZIhvcNAQkEMSIEIHidL37pNEi7bfRCLJiWWfZKJTDE+fMbOwaoFUJILoPu
# MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEIEqgP6Is11yExVyTj4KOZ2ucrsqzP+Nt
# JpqjNPFGEQozMA0GCSqGSIb3DQEBAQUABIICAAqo3f0pzXUWrMcV2dZGLTdXT5z9
# 6VH71xa114yejB58iYEONi+5+GJstNGlUYYxh7aBYty1XFLXTrahB9SNHO1E9xoy
# DULhhhBn+Rhu2Tq5gm8nHgqdkiMxf+2fhhc7lIYJpRkWSO8r3hjXQtF2IdXgemwb
# 75VZG4ViqAQEMYPX2YVk0vZJ2KonLS1xM/ZUu1hYboQv15bAWInavtL5JkdMtmuz
# yIhW8SdFZTet3y1xVJyjeH24n1rCg0vwGyaigmTH/QbiS9/rFseUp4BxsAF3t+hC
# zg4MMy8BBx8Xz5SenfB5lYQFjGKgdv5BqLdqwH35JF6QcDV+rJJOAnABWDTsW2G3
# Xo0AmGoVnMf1wrWqhbIXpm/m2Z7ZEt1ShR48BSw/0raeRLnP8v2RTXcPiIffkfl4
# 52It7znVLUxQsyiE2p4ajZRM3JykZw0eJsBGk4TB6/l23dL9f37HdeDnSRGtpuPu
# T2mGhHNHlVpmwwRi3lwLfOL5gME7QxgdEcE6523ysE5XHJrKATesn638SAwLoEMJ
# 74vSr3WneAo6re6Ed/KVbGS1ykKuhtDDZYVFXZZh0L8TTv/in2ayCfqHWiB9sJB2
# icH/2VldHIaO7MRAERihLksJ1E8564yKoF9Uxu5iZT4NDDZl7NZ5aljFsUIPfSed
# lpgBoruoRM1+awO4
