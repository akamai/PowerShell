...
function Get-METSRemoval {
    ...
    process {
        ...
        if ($DeletionID) {
            $AcceptHeader = 'application/vnd.akamai.mtls-edge-truststore.ca-set-deletion.v1+json'
            $Path = "/mtls-edge-truststore/v1/ca-sets/$CASetID/deletions/$DeletionID"
        }
        else {
            $AcceptHeader = 'application/vnd.akamai.mtls-edge-truststore.ca-set-deletions.v1+json'
            $Path = "/mtls-edge-truststore/v1/ca-sets/$CASetID/deletions"
        }
        $AdditionalHeaders = @{
            'accept' = $AcceptHeader
        }
        ...
        try {
            ...
            if ($null -ne $PSBoundParameters.DeletionID) {
                return $Result
            }
            else {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCuXnDIdxQqJa1g
# dNhqes0c7MyZjgWNBc26z/+hBG2oyaCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgonOVc3sobfMk8p85dJT1zFlG1MjWLcGsetGp4tjttvMw
# DQYJKoZIhvcNAQEBBQAEggIATpTeCqFot1UWJSgH51LJYFgRWlvqbaFxU0SYXNR2
# G+s+0DB8FY8uEIuSxVxRT5n0Njh9r6Os1QjFY8lERFFIBjLG4PVobCs9i/9WYJEK
# YJZPGxB6WitB5+5xlrdugSBEwcHXJ8zaTNy2nKwZgutV/x5U8qJNB5fzJeUeepih
# k5jeGwUW5u+mb3t4YtA1mX2Iefjl6Q5uviwNV4r1asZm168bwNkCC4ZIlJnMWhmq
# 3sf14hxFQ/7Ee2wRvt0DKptTg6akRelvZYB4ByEKB1hViabpDQACkzpB33kX/qe0
# 0q8kS2nrs3FQoGKb2EcvKRBhYpOQAitsSyfmyhxrlG8Xx4AoZTm5h9lEQQX5fhQ0
# LiTZyZ+rlCcXOE9cbIG/HoxA98gPAlOzJS1QwdMx5sKoJrSl6HE+Lyx4PCyxAw9u
# OwR/xkNsIViiriJwP5veVxBvVKcu+aTy5mjTPmN/0+5gO6GHNp3tAqS5G7Wc01ZB
# 3baSxmyPJFx0yVahktkZKEkKkDkY/m7gff2qAvzDqZqR976I2k3CV6RnijB9D2TJ
# G2+CtAjc18B4JvVY0SwpNw2x95DIiTf2b+333V8nIgDi90V6UugS2c8Ogq+7NGVa
# l6Y0F6/+U/UW3Hry5lIeP5m6/javjlZK9m0cWhIA4NzKD5Js465bqKRbMe5BEzlP
# 0SOhghdAMIIXPAYKKwYBBAGCNwMDATGCFywwghcoBgkqhkiG9w0BBwKgghcZMIIX
# FQIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEEoGkEZzBlAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgncGl34MkhLb0uZMRFQP8eQO45l6h
# bAE+zCfe6VmvtbkCEQCayzTe1kl9muGTO5jHGwBbGA8yMDI0MDgxNTE3NDE0Nlqg
...
# DQYLKoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI0MDgxNTE3NDE0NlowKwYL
# KoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLCyQ+CXc6qisnGTxmcz0AwLwYJKoZI
# hvcNAQkEMSIEIDKw3aft6Mr3T/fYVu4sgx9ILA4BHbZjSTw6dcAbdf+2MDcGCyqG
# SIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM0dRAV2hBNm+CitpVmq4zFq9NGprU
# DHgoMA0GCSqGSIb3DQEBAQUABIICAGsW5jVgDj9JpZIsIAvgSpSI4iwnMx9Vor95
# yzFXxBrwbJK4YTjEcSJ2cFlPN5jy8AcOLvQxaZ40xO8adYmNIK0ivnFBYo0JGV9W
# U63wFgU0QstlyMC/a4bzhUiuUJOuJZ6jmREEX7CLP+tnOUv8K1OFEd6io5l7q5vL
# I892Ip6m95AJRcC6Pz2jJB6a+R4Ja6ZOiRl0Y3r26FN41n2G0wPfe8Cv/YxwlWYX
# ZdZgOTfdKdauR2HDns3taLpcdBuER6GzvpW4/Ds4sXy+pLqvX0UcpcUEwuckhNgS
# 4KSGrvM+Rvj7Jnvatq4fCRm/Bm4zEZ5XqnNK//i0q4OzQkT15nrNHNJbVlqVATKw
# ZASXOrZnFmEb8kMB7Sqm24XBTssPgz94SStTL4bng5AGFEbIBrdbqxRkmQ/SC7Sq
# 2wew8IDG8CC7mDyrM1FjpxaHRqHAubX94vkJrC2a3gcBZQ2ykPRaHFQHsu6e/2p5
# v2+a3G9KQri8HNwvZDi98awAEjMYtiE65yl9/Ukp9HdYDQ+4rGo9tH5lvyu8yf+1
# og90Yr1QzGLWjdNzYU3QSJvGMi27mtCcyVJMuiWmxECF2sPRnj7cbGDPUbGGuo24
# 7SFn2FQr+n0dAnI2T7YRhnaT2ZnIa/juSSfTV9UP8l99pqfmy8+kTXBZNnsdNH9u
# VYJfJ2hw
