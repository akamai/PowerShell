...
function Set-METSCASetVersion {
    ...
    Param(
        ...
        [Parameter(ParameterSetName = 'name-dir')]
        [Parameter(ParameterSetName = 'id-dir')]
        [string]
        $Comments,
    ...
    process {
        ...
        $Path = "/mtls-edge-truststore/v1/ca-sets/$CASetID/versions/$VersionID"
        $AdditionalHeaders = @{
            'accept'       = 'application/vnd.akamai.mtls-edge-truststore.ca-set-version.v1+json'
            'content-type' = 'application/vnd.akamai.mtls-edge-truststore.ca-set-version.v1+json'
        }
        
        if (-not $PSCmdlet.ParameterSetName.EndsWith('-body')) {
            $PEMMatch = '-----BEGIN CERTIFICATE-----[a-zA-Z0-9\/\+\r\n=]+-----END CERTIFICATE-----'
            $CertFiles = @()
            $Certificates = @()
            if ($PSCmdlet.ParameterSetName.EndsWith('-file')) {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC7liy/9LKzNGk4
# j106qx7kBXq/dSvpuTOJO3VuRMbZUqCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgVvG2j5S+c8IFAgGNiKfTotz2uD7Sk0XseSA4ApRvY2gw
# DQYJKoZIhvcNAQEBBQAEggIAceaNxAn8sJCIJm6Roto/7mB1RsP+jnukEszBv80C
# TeVZ4aBtx3Uc5gjlV5//frUNrovHhLzxGfg1L5mDV60oQhz3fVULa6dHyVTBxXEu
# WAHZx9hXxBQvdOrs2qtxJs3lLdQBcR1/Z64pgEs4ayJpOR/i/n+g84+NmBHnZtxa
# RF3UBF0wcdCdzIMDmpOslWzIwEcwl9jtIPZJ/Bw0uA1yWL8Hqb8UiMhFtRpjdttL
# 0wuZs/4qLvF/9LiDQYqhd29sL4neCDdcoedFeliSM1+lLJSmIgrm7cvUrfYqbB+7
# IeOjOOLvGQCbarvuDL4KWYfuoAfrPWrtiWRPJfzECki/s+4Kb9nvZeTI6vbpaAHI
# K2ocLLTuoDUzTkFohQenTuO9vRG2Dsv6OG6VYPH5wbCpGE7SIsYrHjC1H9exq5OF
# hq9FR+Kf3SMpn7iKh8yqNqWWwcwnelgEsxQUOqP9Volrcxp35YIkg0nSV+TX6Fkq
# W8A7u4LrxOdYGi3UMp8MFn713E7enAzkoyINTy9LaxQUO0eSt54BVKXUnRkaWhWt
# HG6pTwHjEKUeAUVKjuvn1nixvj+j9UovicovFx9j/8mSf7tUIiBSF8DgYWItuvPo
# QbrCbUtZU3FPc89loVK/gZR7WyAwcfM/0W0D9vIDdnXNRjcpjQLMlaLMo5Cm4128
# Olqhghd3MIIXcwYKKwYBBAGCNwMDATGCF2MwghdfBgkqhkiG9w0BBwKgghdQMIIX
# TAIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEEoGkEZzBlAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgxgrHSxt0I7WEMDVcLQxumTXIG9nb
# mQtwScmygNFFgYECEQDmbgmfQ4FYYVTmr76RrQ5mGA8yMDI1MTExMzIzNDM0NVqg
...
# hvcNAQkDMQ0GCyqGSIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yNTExMTMyMzQz
# NDVaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFN1iMKyGCi0wa9o4sWh5UjAH+0F+
# MC8GCSqGSIb3DQEJBDEiBCCWeziQML6iygS5K/UTbdsg6c5zMxY7T0CDvC+ihV7T
# gjA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBKoD+iLNdchMVck4+CjmdrnK7Ksz/j
# bSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASCAgCnJPlv0fPAW1RE0FFRwpJwBbyd
# l82ulnvz8xPI5AYfiu+7ekXMrx8JNv5dXTZZH3ldY/6S6j7og2fFTRjuQphpJn3R
# xcSZF3DLDB1P+lKYkKduOyKCtJXPFhEAG8tC+Bg3EBuwEOV4b5x6eE5pZNhi7c/5
# itJkGE5lRfa19sn6NnuzGoR0npy5yZVXUVeFzXjhm4qJXAOjKpRfujrmEdGah+OS
# o1cibhtD/yUvVErOatDAAyf/qXAqflONkidGaJli1woAfGRJjb8UT5SiE/nIyCEy
# qwmXKdHAh+z5WZIUSAx58xfyMatSalwJlvdq+Q5K8NlD8CNo8Se950XW4HSWzVg4
# w2YAWpaZrS7pJIqen8iH6g1lHf/mmt7AcgR7XiAbA2ccjJOF60kooouLMiBqFTfI
# HAZornj7uUyMAe8wTIIIcUzNNXV8bdmFdtsChXyoIWbdv1PTqJjECGZcpuc650dq
# 36hssl+01kXKhfsm1MjBEENGCDedLEWZjuYzCxtXGblQBoS88/Na9Gx1MnhEVhgY
# 7uSgdFw/z9FIR/ubzcv3zfanzNeQ+PAg9i8CTeE1pZDZZDm/Noz0LP2haCk5rpdb
# iryqSrq+ZnsTL4TQiWkuRG25Zz2nLUIXQhNI8GYi8XpOIMp2iiQVR7EnpLVevSjK
# JW6BKHqMCvQormaO4Q==
