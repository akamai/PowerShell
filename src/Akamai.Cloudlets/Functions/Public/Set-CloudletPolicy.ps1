function Set-CloudletPolicy {
    [CmdletBinding(DefaultParameterSetName = 'attributes-shared')]
    Param(
        [Parameter(Mandatory)]
        [int]
        $PolicyID,
        ...
        [Parameter(ParameterSetName = 'attributes-legacy')]
        [string]
        $Name,
        
        [Parameter(ParameterSetName = 'attributes-legacy')]
        [Parameter(Mandatory, ParameterSetName = 'attributes-shared')]
        [int]
        $GroupID,
        
        [Parameter(ParameterSetName = 'attributes-legacy')]
        [Parameter(ParameterSetName = 'attributes-shared')]
        [string]
        $Description,
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBtf9keCJnjB9tq
# FRjC6AFHx6/g9OlGMp373VTc5bJbfqCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgngs5tBJD0pyzvzRpHaLIIIWfGwxbakCzlOSy1pMj/AQw
# DQYJKoZIhvcNAQEBBQAEggIATZ4i3+NgxsXzq4pb0h8x6M08L3uXwIiDmf3cCu9C
# 5Ge66/KNRVR3PWBKB49KnqzTIHLveoS691LkOPQGRelgV+0pG+esw/0UQvXaERyx
# dC47IekE4j4KP9UneoLHlQd7z3vMpSWDfx9CTrnTQ8LrvC4wKi/ZIPf3fjQrpOQ0
# lvjdmc6JX/4KB+Uc4lHcPswxnc+P3KWSJYP1rPkysJfcPK63Nfm9vV1Gh0QLe3Ox
# aT303sOOSqua/WW6/LhKecYhFQpBkBknT/gamU8KIHeksp/3GN9UTdiRkZTjZgOg
# zRVYl78R05/KcHXPsFkjMNeKQy6xfxbHapeVsuQ54qub8xlcJ54M3MVw7Z8Z2PKc
# d0IN1/cL/PS6cWqcnpuGT4EqIew1MSpHRaX9AfQF6pS+OJEmS1M//5R1q1tWYNJD
# pVVLh8gCvjZVdcM0UXxicvhXQ4TPnxomqxspYLm8OEShJZGfA6cRDib6bgphkk90
# bMl95X5u8A07PhEyOXHAR7wo7xNLcT2HaZ5md/gZYRxCuDUS/Z01/xCFa6W0NhWU
# 5Wfdu4sTRCepy4tOQ3sl+R/llos0R+yAxLQtAMDdHeqJGHBw6VXj5aFv43EVzcIA
# /S7eyAYmXE3yM2V4lFmMxvM3grmxjXZIMKYeYQ5uPbMSAh1KCiEm07udjhgYq5si
# Scuhghd3MIIXcwYKKwYBBAGCNwMDATGCF2MwghdfBgkqhkiG9w0BBwKgghdQMIIX
# TAIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEEoGkEZzBlAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQg3NoxNKADQYKR14FGTCiWBCeO+B4K
# XZPk79cKpY9O0bwCEQD3/nuGQ2aplTBgrIpHOCS9GA8yMDI1MDgwNTE3NTI0MVqg
...
# MC8GCSqGSIb3DQEJBDEiBCB2xqvsb33263Gov3CNcay+8n1quYsLzhXF6PCQvzzF
# KjA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBKoD+iLNdchMVck4+CjmdrnK7Ksz/j
# bSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASCAgC345mu6Do8CGxsLPw24ok7VcUU
# yHFuhXdIOk927BNcTnWl7E3fQQjvTt09bYOJlduBJ/DFWAu+b2hoDwic6bBzKdMW
# mrxHf5DtppfsxIHwUO5b2FLdLJXybUkQsgWmN69p4mQ8MiXumjOvhFEFrSR0FiNp
# Qa2Sc6fnfWq+uZf1pY3+bai68f4EUpOV7cc8OjanjFqY+EnryKc1dapYrqA9ylxd
# ekeRWRW16aDmgl446/PlUlEV5XN1n3vm0npPXIM0yrHqWrJK21YnchFYLMMsDUCC
# Xbi017E71VzeWtsKuZ7sv0rEGhQCHxQRWS0qHwYaT4UQZvQL/8I8LuChQKpJIoJ6
# TJdK6T99qlXU52jO2utfiW8DJEQ5pCsmK/07auBkxbSMbk18OGgKpA0TFAPPUpEv
# YOgqeHtQlcz959f55/GQwbxbf4RRBKrWcPB+Aibg8F7/505w8tWp31is5rId8ZS3
# fpfQkcoJNucbVOdPZnpTelqQ9qf3pYXyFjrEZ2wGHjVt/Bm6bwm0PPCngJbiWM0N
# CuQnUZRSoyQdF6tiuM56AwsUYI79wqqoflmKgiBvoV1CbkRXDFX4jfqjzTHMkme8
# NAXmUgDlDN5tixRFhrLH1JHh+8gdUCnAmYr4zrgHOS9GflW1E6ZSTxicbU9gWP/G
# ePOSib5kAHu2btzqFA==
