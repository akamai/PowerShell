function Get-CloudletPolicyCSV {
    [CmdletBinding()]
    Param(
        [Parameter(Mandatory)]
        [int]
    ...
    if ($OutputFileName -eq '') {
        $Lines = $Response.Body -split "`n"
        $PolicyName = $Lines | Where-Object { $_.contains("Policy:") }
        $PolicyName = $PolicyName.replace("# Policy: ", "")
        $PolicyName = $PolicyName.Trim()
        $OutputFileName = "$PolicyName-v$Version.csv"
    }

    $Response.Body | Set-Content $OutputFileName
    ...
    Write-Host $OutputFileName -NoNewline
    Write-Host '.'
    return
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCaasBpTn2nCL1H
# 5VzNDt9hvIIng8x0cYBHkV8rGlSfoqCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgfgfwtm6nICxQ0BZNE39B7AGvrzYyBZjkl0fhEQU16/Qw
# DQYJKoZIhvcNAQEBBQAEggIAesTFmoSIXkkYNcNBC8uSjLa86bXwoDURXcgtKRDt
# EEKBHDvnjlj2uzxwYJrxuGWUda3hlH8cxpbXuSmQjvhFskZ++TskqBd/pRXUSZIz
# q+/w8cWqJXnwE1mILmHM0GPqP7csJX24cKQTVdKzVA0JuAn6fvA6iuPpd2RmiB/L
# i+PArPRyppJWOHPSDSiuJAMZF66P8s9VEc0jCA/chaEzEQNqy1KxrWafwoWVo9Sg
# /qSzQ4xe086t6vKoTauL6ogVGB+wV4v5iQ22nQkDHCtcI9kAYUlZqagtl8mnBvss
# FjM3ES4fRe8CeU6agYGm3kbZFkhkG7mVi8Zm/jvV7n3N7OLLuHfbkapSEcITbWuT
# iLSRpeTspC+GfhnW+ZGeOFmBcRMGBJqcCrDSDt0XH2e72Sbq2GQWsL9IQVsIfYTx
# A55SublPrwzZ7SkO2Q0anNtCrRF6GrMd5aJfFUsgROhcEJ3LGhyPfc+UhaaiuWhq
# GFl03ETyJ26mk8L9o6DdnydziNQzfiImaYPMdDJUbABZHQfKemaFiAcqGGsKKIZq
# QSQTR+p/mIsy9BAPBYEuBjQerjUlfeQkl2qraIebdCxzfyUJSRkLXPWPrWcWfQWz
# gWCSpYbcc/UoIaB1yMvXMWQYR9JKEa2tYxQVkSEDzEemPMESxGZvG7fRnUUsUwZO
# e3Whghd3MIIXcwYKKwYBBAGCNwMDATGCF2MwghdfBgkqhkiG9w0BBwKgghdQMIIX
# TAIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEEoGkEZzBlAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgqufhzmIk1Cht9tVo3W4IuZOyCtB7
# xhtK3WnjWvOYXmUCEQDL++FEwguWf0bTz0Vlxt7eGA8yMDI1MDgwNTE3NTMyM1qg
...
# hvcNAQkDMQ0GCyqGSIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yNTA4MDUxNzUz
# MjNaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFN1iMKyGCi0wa9o4sWh5UjAH+0F+
# MC8GCSqGSIb3DQEJBDEiBCBnMqv3WmnXgn3B27uHeZz4fXa0nkVn+gyuobq6vuZW
# pDA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBKoD+iLNdchMVck4+CjmdrnK7Ksz/j
# bSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASCAgBrnygc/kQg6xMqShSKSD2HnI+d
# N0FnOycqoQXG/9kZLZNKsXOH2l1H5LNZOV66P6tQDmSn5JaqQXx1NTOdS8jJBVkI
# Tuxc+rLPvqxg/SwkNd1B2cz+LPLdfgFc7mbQ+ZyhDIug1A8+TePLB8+X2O0EUYx+
# JOSroZuPwzy+BJdKnuKpJqVdZQGO58kGZsBtVMkcIM6FDXRh0Nuh4yNPQp6w58gl
# H5IT+PuDa7E+l1FbX6EV+4rOt/dyYYbiIeftkn8nq6hKTAB7YctajAwd4IFVzK+h
# /+TKP8JDesUrkg8ikrjt/zrFgDZMbyvYK3jw4NFOlU7kpoGBsNYOzdnmCxRpEu3t
# 1q8pA2Azaw+OMHucxaciOcUgiYMoPX9MuflOObX0fFNb1IkPfC/LhrCUJK7QQRmE
# g4OyVKvp0UqFFTP4jwQmUBtr33KIkCZS6tu67RPjIN2KteEG/rrOV0NB/9Nn7PjE
# CTL+ryXV6O+NcUsZNePF/MBtG9/YwYjTx5TiIXpf4T4V9jBRRB0STwNb0g+A+ABv
# QqxldRl33lm1B3QXvORY/IvGvWmQzzaR1v+ZJfOvOS9SbafN5X77ivD6IVlTaFbk
# fXdJFnAUATfrfhWHJnrWb2CbfmCdofveLJ8gQBnFD2BpL08xEMiKeXAFUaeoOlYP
# mclF+yH3wGwdefSecQ==
