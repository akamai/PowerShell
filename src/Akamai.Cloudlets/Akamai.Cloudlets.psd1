#
# Module manifest for module 'Akamai.Cloudlets'
#
...
RootModule = 'Akamai.Cloudlets.psm1'
...
GUID = 'f3177805-a7e7-4b1b-8a9b-4f13f6e87457'
...
Description = 'Functions to manage the Akamai Cloudlets API.'
...
FunctionsToExport = 'Copy-CloudletPolicy', 'Get-Cloudlet', 'Get-CloudletGroup', 
               'Get-CloudletLoadBalancer', 'Get-CloudletLoadBalancerActivation', 
               'Get-CloudletLoadBalancerVersion', 'Get-CloudletPolicy', 
               'Get-CloudletPolicyActivation', 'Get-CloudletPolicyCSV', 
               'Get-CloudletPolicyProperty', 'Get-CloudletPolicyVersion', 
               'Get-CloudletPolicyVersionRule', 'Get-CloudletProperty', 
               'Get-CloudletSchema', 'New-CloudletLoadBalancer', 
               'New-CloudletLoadBalancerActivation', 
               'New-CloudletLoadBalancerVersion', 'New-CloudletPolicy', 
               'New-CloudletPolicyActivation', 'New-CloudletPolicyDeactivation', 
               'New-CloudletPolicyVersion', 'New-CloudletPolicyVersionRule', 
               'Remove-CloudletPolicy', 'Remove-CloudletPolicyVersion', 
               'Set-CloudletLoadBalancer', 'Set-CloudletLoadBalancerVersion', 
               'Set-CloudletPolicy', 'Set-CloudletPolicyVersion', 
               'Set-CloudletPolicyVersionRule', 
               'Expand-CloudletLoadBalancerDetails', 
               'Expand-CloudletPolicyDetails'
...
AliasesToExport = 'Deploy-CloudletLoadBalancer', 'Deploy-CloudletPolicy', 
               'Disable-CloudletPolicy'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD6xV1s5HYhq4gN
# KYvQapg1u4kW5cdtm6hKnlEIh+yFjqCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQg6Y82lfFHMb9n+DjgoU2j05Ko3Y3XdvFaQ6zYtg9Ej0ow
# DQYJKoZIhvcNAQEBBQAEggIAq/y2RZjho+LWab55UzWLmUrT0jKXAixXXm/l7UGJ
# C+eUI5mqzaqv2HD2rD7qThIraKRSsCHuf6zdrNzusGvSLzgOcpRPfq4HfNPXO4UE
# VArEoJGd8iTvKcv7cajarA1Bz3jte11UhxoRGTtyFdPiUheO5aAXJt0tuOE3Lcap
# DX0ABvG6UUuafQ81aEUXapDlZleNvPTskqnghiPGVQQ9wz58B6GgDmKnACNFFDyf
# TXeo4Ek40qPs0kmuaZ+5HUttHtH5rahTPWGOMOrVFzmpF153qAbKgvSZSQbDyOL7
