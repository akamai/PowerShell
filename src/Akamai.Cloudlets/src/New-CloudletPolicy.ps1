function New-CloudletPolicy {
    ...
    Param(
        ...
        [Parameter(Mandatory)]
        [ValidateSet('API Prioritization', 'Application Load Balancer', 'Audience Segmentation', 'Edge Redirector', 'Forward Rewrite', 'Phased Release', 'Request Control', 'Virtual Waiting Room', 'Visitor Prioritization')]
        [string]
        $CloudletType,
    ...
    if ($Legacy) {
        ...
        switch ($CloudletType) {
            ...
            'Virtual Waiting Room' { throw "'Virtual Waiting Room' policies must use the -Legacy parameter" }
        ...
        switch ($CloudletType) {
            ...
            'Application Load Balancer' { throw "Shared policies cannot currently be of type 'Application Load Balancer'. Please try again without the -Legacy parameter" }
            ...
            'Virtual Waiting Room' { $SharedType = 'VWR' }
            'Visitor Prioritization' { throw "Shared policies cannot be of type 'Visitor Prioritization'. Please try again without the -Legacy parameter" }
        }
    ...
    try {
        $Result = Invoke-AkamaiRestMethod -Method POST -Path $Path -QueryParameters $QueryParameters -EdgeRCFile $EdgeRCFile -Section $Section -AccountSwitchKey $AccountSwitchKey -Body $Body
        return $Result
    }
    catch {
        throw $_
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCpW1oAxax8F541
# Za166YmRBAMKecS0//e6JfMd+WtNuKCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgRdE4f7iiaS3d+PQUhWHrHiqNXonvAo0xlXTGCy55jIkw
# DQYJKoZIhvcNAQEBBQAEggIALUmajGm375PiC4c1G1blzzfqa8LsSaxptwYvifbN
# 7LK6z5wEy0kY/mAGq4FyjRld5bnDu25pY+wcPyCXV1LXhjWPDR3ywREqT01m+i3g
# SXceSoab96cNFNPCFRntVm9AynVGIRfRo1OVkK1gWs92Ju9DByrGiQVUmQG1LOMZ
# Sh1SWcrRTa67JMmfotqUkUlqeDhS8tWAtxljGpgAelAqaTeW0E6sSOKBKDSSp0Fk
# xnzVfGreOzbsHYNggKdGpI9STc3axiMBbTbQrUVlCUWw6bpjYd5xWwcIiKfPCaq4
# DUffg6mNXSRH/ewotpjSYa3XfbCFEcPsuDtpYkNSyxAoo1ynpc9wcS8jPi2tiaYQ
# iAdwKkE0wujf9MzVJ3j9beaWfKy1uO105iwsSEOnLy7DXu2P6MoQiopeNoWgz9fl
# 7h55/4Lyx0LfFjZ2SUejUwe/Rj4xmlk3PSDoqoug54t7cbeD1tBr8V/jtwnN9tOU
# J6vH8wD34UzeP2qTMAWd5+OICvje5Vfoo+47MW9Dg+ooamC/o7oadA1OPnJnZjo3
# xh/WdL3XI51cbuddKdkhoum+QuYJzbx5l2Ot6bWdX/NWCMWU9WknLXhN4CpN+TeF
# UkoK2FS6HoB5PvkO/4QVFkTnD+OtnZcKCQimyxFCyjoAwoKnLUkmKsBH5ywG00++
# jEChghc/MIIXOwYKKwYBBAGCNwMDATGCFyswghcnBgkqhkiG9w0BBwKgghcYMIIX
# FAIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEEoGgEZjBkAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgwdmkaDCE4r8vGYTpfFcD47SSi+nw
# pk87k5TkTrojAPcCEEnAdD9x8OCNQkLr6OcO9VIYDzIwMjQwNDExMTUyMzQ2WqCC
...
# BgsqhkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjQwNDExMTUyMzQ2WjArBgsq
# hkiG9w0BCRACDDEcMBowGDAWBBRm8CsywsLJD4JdzqqKycZPGZzPQDAvBgkqhkiG
# 9w0BCQQxIgQg/Q/OuIxoVTj4Ctkmxq7no/zt+knnIbgEYHdN1CPyGPswNwYLKoZI
# hvcNAQkQAi8xKDAmMCQwIgQg0vbkbe10IszR1EBXaEE2b4KK2lWarjMWr00amtQM
# eCgwDQYJKoZIhvcNAQEBBQAEggIAfyIOhmQs5S1vwv6NxHjx5YZiZgdvLcwq3pgq
# Rpijf4YcQLYcmNec54wvSMU7JvfQ79HgRCRzv2DMDOp6b+FXwMkZHsO1R4YCbPs+
# K/zTZPNW2B+is0pjkoFyMoOmgvM6gyMleQ/rnHI4MK/vSs0AUiEZ17kjaOzLqri7
# EoAXStM1apeG4aqdnWCse9efzvLDXmKnl7215YfC3sUya2Ee7VHVk+45JOJL+yak
# tExWhixWBWNywVqo9PN8vnlYO2eNc2wKdO0F9GuuzkbADh04hdsXQPXoMPbBfHJ6
# 7BhR+7+Hm9ltwpEVOUbwKiNqWUQTMcXBXm7FENjd8249RFteIQl9i5c3DHI1pQnk
# ShVe45h23iMN3OXmulZHFPF/fB75kvKrqaq57ls2NMMA9Vnh24Ds/EQoaOQzupGf
# M0sDPzzSG0oZQvMKMuI+jmODQzPVE7dh/iXBHHoyyRY5Ao0+nhgSvG8drhNdsnmQ
# /pmndpm3Vv4+T2QCelzLQcTAD/T47ZgF/YfcMr+WsEf7D3XXSFgtyp5YQrdzUC0W
# Up/Ola17DqL6IKJmFNLu4itIqSbgAxyU/ADytsUwIsXpvdCJKj9WK4QEEmblkG0r
# ZCL90qqXNDZk1Ov+92/5X6i9b4TxFrOp+QH65lxEzuqlP21ZW415KwQUEg3UCIjg
# GoKcp/g=
