function New-PropertyInclude {
    [CmdletBinding(DefaultParameterSetName = 'attributes-name')]
    Param(
        [Parameter(ParameterSetName = 'attributes-name', Mandatory)]
        [Parameter(ParameterSetName = 'attributes-id', Mandatory)]
        [string]
        $Name,
        ...
        [Parameter(ParameterSetName = 'attributes-name')]
        [Parameter(ParameterSetName = 'attributes-id')]
        [string]
        $RuleFormat,
    ...
    begin {}
    process {
        $CloneIncludeID, $CloneIncludeVersion, $GroupID, $ContractId = Expand-PropertyIncludeDetails @PSBoundParameters
        ...
        try {
            ...
            if ($Result.includeLink -Match '\/includes\/([^\?]+)') {
                $Result | Add-Member -NotePropertyName 'includeId' -NotePropertyValue $matches[1]
            }
            return $Result
        }
        catch {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCxqSl+HfmP0SjR
# XKz9nlZU/tXAhf1VqEZnZj8BPOrud6CCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgN1QHCftM4m7hEf7LEmi02XSPOdLEwPAAZVnBfVTa26Qw
# DQYJKoZIhvcNAQEBBQAEggIAweLl6UbYFkQlvL+pJ5khnG1boc+j+d3asbhi/Zzc
# 0SA8XCTL0a0uZrz5t4oroBGLjw3hr+N24eo6xoGkdyKLG/jCoopraalM76L0ngZo
# 3LtZX4zg+B708zoboy0FKtb3DXrga5KrBadGeXZV3zjscH6At59Fruqr2KZ1yEPL
# kq49cZOhal8V+LIP1jN3nIxo8q/pNihUFKDY1l9pcZL2PIGiDDmU6SOjP1fsWK2D
# FNRGY8MB1IQIUAIPjb4r/qacxpty1fQ2C2W7zfJEM7YVhxtm1coS6Ri6UToOv0Zs
# rOPq4si52T8jNlZhnoiDJ/ojxF+g5+Q7+fAEvP8AyrYZmJKW0/eiQGxdWRnUxcVs
# FFJ7cvtSC9lwrfPTeHRFY4f+eShEuwAhcibITIaUsrTAT/TBbNPy0Pb3p+jlHTr1
# dhvYkatP6aypX6pZEkjyR6WAlji5GB/HTdfdXr2aUY8SD0331iPwJxu8tKNCiSoU
# 3LX2MyC4NSimF0fVEQsOxJrE3rKnGvQ6nm2rc+Lt8+LcC+P8ne+QMkkhnnnkxnkc
# uVtsKsmEemOrkwQNZv4DVb+gKOE4dcQrWPXC2ZCqcJXzZOApJ6GBWAD8HZJIiQ4p
# FpGLX2O99FcZ1beYM8eZfyHE2fyfAKQ+duyeCgk9mPfOFGj3TuIAGJVz2gAd3s5L
# 7j2hghc/MIIXOwYKKwYBBAGCNwMDATGCFyswghcnBgkqhkiG9w0BBwKgghcYMIIX
# FAIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEEoGgEZjBkAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgPN4XhMLHDZ7w7KHUacZyDoi71/sh
# eW3qOeF6FZJ7dIkCEH9ds6C4+EDL8fOQANEeF+UYDzIwMjQwODE1MTcyOTQzWqCC
...
# BgsqhkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjQwODE1MTcyOTQzWjArBgsq
# hkiG9w0BCRACDDEcMBowGDAWBBRm8CsywsLJD4JdzqqKycZPGZzPQDAvBgkqhkiG
# 9w0BCQQxIgQgnr6QwLoQY4kuufohKWDYYPj+u9FD8ngC7bHCw23tb/4wNwYLKoZI
# hvcNAQkQAi8xKDAmMCQwIgQg0vbkbe10IszR1EBXaEE2b4KK2lWarjMWr00amtQM
# eCgwDQYJKoZIhvcNAQEBBQAEggIAeB0W68Kdo0qQe+e9kAqoPgS5/SeOX1Qu4E6M
# zDra6hxC24/q+rBPTDfJg2qOHQN2X2g45hs4j0TNHiL6BnlZaZq5GhrS2SGCyqHt
# 59+nnkRPTg3geIcw6AjxeYOIY/76xkURVEnL5x6nGI+1xzq1JmLLe4bwj37zn0hR
# r/5eTzctpbw398s4Hlo3NkyJr5UIrhhHfhdkEB9dTliZ+TtNWblbdjCTQsXrLxv6
# T72snP6p+6fzM4WR6ESmPyUgBoCB4yWfHssBNv4LuoP+LP/s13BSFS0tr6i88J83
# VlwRDrlfe75whKypa+Ec5DTIIX4XsXmS1wYnLsrLfX2C33QJXuJ67n8Mj7e4znlM
# ZR5N4XsRJj2wT4Bxf1tYYTeX7dhUSduE/QzZ1fbtwCiJHFas72uKrbONTjJoVhkI
# +tQpsIFzG4rLDD47Ek8072xpOnU6gBR8bEEhLyYPmQn8c4NI0Kk9Frois/84FwpR
# 9JrvXqng4Z8/PNBlng+piaQssWb54KDRiA/U8cYdma88+at8M0pr5lJQSfw79Jmr
# 1N4cDh3UjMWRXFzKmXkwqOeamFNcai7CoFPRDyB2g49zSk3XzWwJ/qafd66WcFWo
# 5GGWP9rcrJWrGr7X8Qo4fDdeC5juz/ogIg9UXFZi0k0GhOc9JqplCIzMiqf5EQPJ
# AeqHSrQ=
