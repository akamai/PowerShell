#
# Module manifest for module 'Akamai.Property'
#
...
RootModule = 'Akamai.Property.psm1'
...
GUID = 'e93caf17-1c3a-4926-b103-d984596aa47c'
...
Description = 'Functions to manage the Akamai Property API.'
...
FunctionsToExport = 'Add-BucketHostname', 'Add-PropertyHostname', 'Add-PropertyRule', 
               'Compare-BucketHostname', 'Copy-Property', 'Copy-PropertyInclude', 
               'Find-Property', 'Get-AccountID', 'Get-BucketActivation', 
               'Get-BucketHostname', 'Get-BulkActivatedProperty', 
               'Get-BulkPatchedProperty', 'Get-BulkSearchResult', 
               'Get-BulkVersionedProperty', 'Get-CustomBehavior', 
               'Get-CustomOverride', 'Get-Group', 'Get-HostnameAuditHistory', 
               'Get-Product', 'Get-ProductUseCases', 'Get-Property', 
               'Get-PropertyActivation', 'Get-PropertyBehaviors', 
               'Get-PropertyBuild', 'Get-PropertyCertificateChallenge', 
               'Get-PropertyClientSettings', 'Get-PropertyContract', 
               'Get-PropertyCPCode', 'Get-PropertyCriteria', 
               'Get-PropertyEdgeHostname', 'Get-PropertyHostname', 
               'Get-PropertyInclude', 'Get-PropertyIncludeActivation', 
               'Get-PropertyIncludeBehaviors', 'Get-PropertyIncludeCriteria', 
               'Get-PropertyIncludeRules', 'Get-PropertyIncludeRulesDigest', 
               'Get-PropertyIncludeVersion', 'Get-PropertyRequestSchema', 
               'Get-PropertyRules', 'Get-PropertyRulesDigest', 'Get-PropertyVersion', 
               'Get-PropertyVersionInclude', 'Get-RuleFormat', 
               'Get-RuleFormatSchema', 'Get-TopLevelGroup', 'Merge-PropertyRules', 
               'New-BulkActivation', 'New-BulkPatch', 'New-BulkSearch', 
               'New-BulkVersion', 'New-CPCode', 'New-EdgeHostname', 'New-Property', 
               'New-PropertyActivation', 'New-PropertyDeactivation', 
               'New-PropertyInclude', 'New-PropertyIncludeActivation', 
               'New-PropertyIncludeDeactivation', 'New-PropertyIncludeVersion', 
               'New-PropertyVersion', 'Remove-BucketHostname', 'Remove-Property', 
               'Remove-PropertyHostname', 'Remove-PropertyInclude', 
               'Remove-PropertyRule', 'Set-PropertyClientSettings', 
               'Set-PropertyHostname', 'Set-PropertyIncludeRules', 
               'Set-PropertyRules', 'Test-PropertyInclude', 'Test-PropertyRule', 
               'Undo-BucketActivation', 'Undo-PropertyActivation', 
               'Undo-PropertyIncludeActivation', 'Update-PropertyRule', 
               'Expand-ChildRuleSnippet', 'Expand-PropertyDetails', 
               'Expand-PropertyIncludeDetails', 'Get-ChildRuleSnippet'
...
AliasesToExport = 'Deploy-Property', 'Disable-Property', 'Deploy-PropertyInclude', 
               'Disable-PropertyInclude', 'Restore-Property', 
               'Restore-PropertyInclude'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCn6viIwxQ2oCHs
# HA6tf1OZPHvRYm9MvNCDWohJOSwPxKCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQ