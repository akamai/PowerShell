function Get-ChildRuleSnippet {
    ...
    if ($null -ne $ForceSlashStyle) {
        if ($ForceSlashStyle -eq 'Windows') {
            $OSSlashChar = '\'
        }
        else {
            $OSSlashChar = '/'
    ...
    if ($NewDepth -lt $MaxDepth) {
        ...
        for ($i = 0; $i -lt $Rules.children.count; $i++) {
            ...
            if ($PathFromMainJson) {
                ...
                $Rules.children[$i] = "#include:$($ChildPath.SubString($ChildPath.IndexOf($OSSlashChar) + 1))$OSSlashChar$SafeChildName.json"
            }
            else {
    ...
    $Rules | ConvertTo-Json -Depth 100 | Set-Content "$Path$OSSlashChar$SafeName.json"
}
# SIG # Begin signature block
# MIIpoQYJKoZIhvcNAQcCoIIpkjCCKY4CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCyvsNrP2BoHer1
# LFD37+ApBl4VcEg2b7EfLasIyAsKfKCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgXIROTvarYgX3rmmdbtOayuvBrFi1L9gsQgA6xWw7vzQw
# DQYJKoZIhvcNAQEBBQAEggIAPAM+cRjUZlrLLDbtMdubZFcX9uoAPA0j4KNx0iKs
# IaJWGtb0A5S0jycFR5D9EaGxZlhV4ABv/sEkqaiHSDqpoDxzchEsYsObSqj5Plf9
# dcViLBHsrviHCfLM1KqcDmynPrl3pnFKgLxXm1ffwgJsEu3iH2NdidZ8/9B65UQD
# oL3tkRNkZ4XzQrm61KY6sYWybiN5HXr6C91ozIFKm2wX+iiW0O1ser6VNzEiGbzR
# LPVFAbC/UsdzgtzbLEo5rGg7JnxhGxA+vz983WvyNHZFPpdN/aDpt0N8eYO8cCAa
# UT05RIhVksd6tZFnG3Jc7MGEEcdZD+xswKBumtN10XH81dS2LGBg5b+DiPdi6Sdp
# IA2pFplfUGeU1VyCqP/CIaLjUo4SxZ8zSsOOYDsD+owO4cByrXnbag06ypYPT+IR
# hoDf6RXGPenume/M5CSqoj4ywGsvFU5mTYfygwdeVVrzBuS4W5CZNgpBtZVvCr0u
# gtDOnnhDaVKzvDG5P7eL0yUK58ZHsPoyR+HtJ8uFLvCGLFAiRr4apOSpbJHASIk4
# HFHMkhPc2KoKTfTH0kOaYhczv+Gaa8aevqYiFyFKBG9J8nVx6uC0RYhHYUPZacLk
# VpLwvil+wyFRzBmm2Mxpbptve4/+xe10cax4VhChGsZobpH7gOUUrY8AlK7J4D25
# e9ahghc/MIIXOwYKKwYBBAGCNwMDATGCFyswghcnBgkqhkiG9w0BBwKgghcYMIIX
# FAIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEEoGgEZjBkAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgm9J4X8nyWKG94zSwhmtEaiENIoai
# 2T6CvKjZOJhB450CECMwncukVRtVbsBcNm6DW/QYDzIwMjQwNDExMTYyODEwWqCC
...
# BgsqhkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjQwNDExMTYyODEwWjArBgsq
# hkiG9w0BCRACDDEcMBowGDAWBBRm8CsywsLJD4JdzqqKycZPGZzPQDAvBgkqhkiG
# 9w0BCQQxIgQgCrUQqTvkn4K0NL9AX+LJ3nPeMTdb4b3sAmvXeIgSzEAwNwYLKoZI
# hvcNAQkQAi8xKDAmMCQwIgQg0vbkbe10IszR1EBXaEE2b4KK2lWarjMWr00amtQM
# eCgwDQYJKoZIhvcNAQEBBQAEggIAG24cJ/6ZE9dKquepzK7xBjdpcLHdxL0jcW5B
# KuoHYHFAeVSfJ53Ks7/5EJhFiLdg2DLUerNmGDgyLtq1Bfi0t/zmTQ7bUuvDwDdf
# QNpJbGL1IlShmPcW03RoXzisz23RRjO0LvV/klDCEho7iEmiTQrFFJlUWxqwPmYQ
# Gd8TYAraelB0XmM6nIik+2d8G3A9cmYcFPHOv925uwBwo2hWlpE34DW1DW1V9aT2
# sdFzqz4Yec0/m22q2Sspz0PJEHy6UsEvknxnRoGSCdbWAi0WPcr07or752Qjc8fm
# XCT5fyzYwTiyTRXyS9ne6QRAsUgcwgYXt1W0SQjRDvgY2hZCYEyRKmEEUIn0JY7M
# uWjo5H62LH9wLKAugSLFtyDCMa+lrDR8nXttZXl8AWAhwlINcowkNvaNePI1mmst
# HRRRV5NFmVwfW5I3buRBIegCSuKFBYqvwo9ELnjgDZsrhT4eu8YPXYqc+RllJuwP
# N6AYxSRyn/gR2kdh3+g6dT8DI6HUjOMo9sgpcgQ9ZICc8WNr36EJ233kvsyaH2Qy
# QRf7WDvHwhrq1OEe22ZrRiKY6RZlIDJlb/hV7o+Uq3goGcE3zsjvLntTQo96UUiB
# yQiKbTdBEsqhLlW411XEUDjytC2VFeNUHCeX4lFza9ZqNgzzLw3RQruzLwr86F2u
# aVIGs9U=
