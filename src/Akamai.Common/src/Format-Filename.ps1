<#
  .SYNOPSIS
  Formats a filename for consistency.

  .DESCRIPTION
  The `Format-Filename` cmdlet encodes invalid characters in `file/directory` names.

  .PARAMETER Filename
  The name of the file to format.

  .OUTPUTS
  A `PSCustomObject` converted from a JSON formatted API response.

  .EXAMPLE
  Format-FileName -FileName "My*Bad/File\Name!.txt"
#>
...
function Format-FileName {
    ...
    if ($PSVersionTable.Version.Major -lt 6) {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCX5sp0jRzLXxKn
# uVTH8782UZTLBbW4GtveFml9X0AC16CCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgVLdOvMIPodBQ4FDuyPygzv2S59MT4N6tEOQlJMqEobMw
# DQYJKoZIhvcNAQEBBQAEggIAvxGN9sg1yLy9ZyDh1RgabU/ZJsr9LCddXrGW76a8
# oClTcsZL73u6JRPIlLKJwK2f/zpr6UYtmNJWxkgQi0J+4M0hT25mpdJAnvFKrTbE
# 8tLyZ8oK9WfhLw5yoh1TE089BlRnJk1hiCMkr7eqdBr33xsq5HsfoSjAiS1lzxYE
# t+NYu+ivk0oNoG7Ln6I3scbdBF5qo3B7/JLR6kPPXqWvtLXuLGzS7qsp8sGvWw5p
# iF88MJMiDwtxDTIyQVh0prBFrn/mmsz8rud5dcN/7KyhHwQdbGaCR0zfNoJh6zuH
# w2X1ZZ8zzVHqcIUSIhtBfFzwRKoX/xwUx5srHYLadyFaNKoF3lJJ8zrxyiRfbCsJ
# IaecKKJmmwvImXT3j1tDvbXjhGJA63IxfjLeKAFoQ9F0UfhmxCZLsqWeSJzHYT8G
# 9PY+kBac208RGa+2Fl6CxQ4B9zoPLPhsJP3wa6J70OTxlDzsT3ECb1V51bKrY8jX
# dt55MryM2ndKu2BGB+kUQa/qup4d++sxi3QJBjmgBIhsxX2gbnHvE/RpmraYSkej
# y+z04HG4mvpufxT7Hnt8n+8NrrWA/Ed7wewDbr9/2w0yWn0Tylzh+Wi84IPeDCiP
# Kf6mHiOJGCoJwJR1vGxD5kpPgbpfqny9+m47fO6+9i1VbFn+vXb6tEFxhc5GEbD7
# HXGhghc/MIIXOwYKKwYBBAGCNwMDATGCFyswghcnBgkqhkiG9w0BBwKgghcYMIIX
# FAIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEEoGgEZjBkAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgkwhaq25IZcRr/hymMeZTzugIoL84
# d4b+UI5LggpTtyYCEHxas3W1CJW8w0egmpR8JLkYDzIwMjQwNDExMTUyNzAxWqCC
...
# BgsqhkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjQwNDExMTUyNzAxWjArBgsq
# hkiG9w0BCRACDDEcMBowGDAWBBRm8CsywsLJD4JdzqqKycZPGZzPQDAvBgkqhkiG
# 9w0BCQQxIgQg3xFYbKn5cIJgXQ7Ra1wfHwya3FhtFkTvw4CYcljrmOwwNwYLKoZI
# hvcNAQkQAi8xKDAmMCQwIgQg0vbkbe10IszR1EBXaEE2b4KK2lWarjMWr00amtQM
# eCgwDQYJKoZIhvcNAQEBBQAEggIAN731QojXcsZP1Z1ZytKLTYBIhEqahVISBQV9
# i8D6AYH3Hr6do2ghXa0mujMGYFpAH7k6VE1Bc/6w2anj0nX3DubOepL3y/6ULezp
# vVIjMZXisxmHalJzkrYlkucMawDTqMEANcjWzvE8aT8OSXE/OqlwCxEj14dtHQII
# lCui2XgPpsOY6DhCkexvCA1nWe+IDqZRfkgwdvz2Wr59cZ7MSkjKhdLLzaSWGgYZ
# EDxtpTHkSEQ+pUuXzSVnSfmBugTGLOJSUWKoKXXWJRnnHmvJfl4omk6jUs/Csetp
# leE70gU1LZC7JcAprnSnDfRDw4Uc00vDh23Aj2U8ertmnWf/MHa0mkCpW2aybQ90
# B0zX6ivn12vncgjM7y7jvGiAQmS7TMOXuwX+jjk71Dzhzn5oc3FRqKuEHWvSKiVG
# u7124dULDSPY67fOcbRCQE9yfiXRkZRJU4x+CPOgWkQxj0r5ybYya0NiJqliaJxM
# q8uL9tDjSAdIkRSQkTIVAIYJkcG1AQqqXbdJa0xl9JTdcH8ZSFv+MbvUm7EZQtqA
# EvGLTElWogktSgarDKQGyUQNSDuQXwIaVnl9Ix1oMbhvAMg7E5o38C/PF+zobEQs
# ubtxMz3W5adq/aPQWgSgVzvrgUt4B7fuLGM4Qk0H+GPt9bVmvpIjKt0D5M+OC4oX
# P2qjDxg=
