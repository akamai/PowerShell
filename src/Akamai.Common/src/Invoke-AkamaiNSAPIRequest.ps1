<#
  ...
  .LINK
  Online version: https://techdocs.akamai.com/powershell/reference/invoke-akamainsapirequest
#>
...
function Invoke-AkamaiNSAPIRequest {
    ...
    Param(
        ...
        [Parameter(Mandatory)]
        [string]
        [ValidateSet('delete', 'dir', 'download', 'du', 'list', 'mkdir', 'mtime', 'quick-delete', 'rename', 'rmdir', 'stat', 'symlink', 'upload')] $Action,
    ...
    # Create sign-string for encrypting, reuse shared Get-Crypto
    $SignString = "$Path`nx-akamai-acs-action:$ActionHeader`n"
    $EncryptMessage = $AuthDataHeader + $SignString
    $Signature = Get-Crypto -secret $Auth.key -message $EncryptMessage
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD6vXNnyj4zq2wi
# owQtTSk/8BV3a6iUiGbr3ZBXmC9HrqCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgF6atReNt9CHwiR4nNb6r+V3WTbMscA1RzJm13OBWeYww
# DQYJKoZIhvcNAQEBBQAEggIAMzZ263GhX6hA4DfuD4gI4aByzyG/ZAXn8nz4Z3p5
# qNlx4LIPJ/hUR7wa3K12cEqirI2JusjoDsjMBlgSw7/fsSsdiYZY6+jQI5Jixkis
# cAUmE+XArQ27WGdVtAN9sonRn7JDju/fpQwo+ssbtDW13tNL+dwRglJ1J39Z0sNp
# vT4rCErxvHbFd8C1HZVGTSF92j00hAPfZj7XM/ffmweI8WvY/S/XCCAR5FZWEQNT
# arNcuSDvjboCKeRngwTZ1SyjLqTpsD4q5+4wTpL3Ry9MVnkQo0QRYfNfI9znlAHu
# 7BroGEGvTh0/RO+wO0nhYA1yINc/xoBRMP7e9u8b1yOZ9ywUq2dmK3aRbdqXe4oE
# mbFf/l0WLNydaUjxMNYPynGK7FGbG7p+TIY9CRMKnqvaXmvxYn7I/bMa1OL1ta7P
# zUuQu0mhmUR0HDYGm62WwwCzds3A5tJk7niEXbeYln2sWzentY0TeMR8jvMPp3x+
# 5Tyuf83Kn8aAMGDAKdWNQUAwjEIvMZJhOIubA2wTB14bQAbHsCPibjexbs5rpd4Y
# 0Gkw7mj0ujl4+c1c+/4saq9CtIrLzkJpXNFdSYZHJCNDUpMaRaZM9iCOmMPAsROP
# KqOAxX6fQjFhxyOWFmmbRtN5qkQl9fiMRZyBONRhosRZ/lmLF95IXwpNtBKJCE4i
# 4P6hghc/MIIXOwYKKwYBBAGCNwMDATGCFyswghcnBgkqhkiG9w0BBwKgghcYMIIX
# FAIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEEoGgEZjBkAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQg00oyilEGCwBanup8Ij7bJRopX7sn
# 5MzWpMkupyJpOpQCEDQ0iEscfLVUtS1ABDavxgkYDzIwMjQwNDExMTUyODA2WqCC
...
# BgsqhkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjQwNDExMTUyODA2WjArBgsq
# hkiG9w0BCRACDDEcMBowGDAWBBRm8CsywsLJD4JdzqqKycZPGZzPQDAvBgkqhkiG
# 9w0BCQQxIgQgVHA/b2N26KFMgbm0vXp7FEqB5sHlLvpztt0RLrg6BScwNwYLKoZI
# hvcNAQkQAi8xKDAmMCQwIgQg0vbkbe10IszR1EBXaEE2b4KK2lWarjMWr00amtQM
# eCgwDQYJKoZIhvcNAQEBBQAEggIAEJ3xxaZgIHk5HEkdRq4YyF82oyPchIQQK1MA
# fZoX+PGkEH82CJA1WBWFnRcq1md6IEIx/kQS76+ekUOuIDOHx5lczPPJQiQcPA27
# vz2yx/rsG/pNJ2i7Nig0vWZt0Mb8uXcbfVDsyhE7zP2EedKRNTy4yOclxGHSEL02
# E7SfWmViCsW9trQZgttC9drpaFpDzCl78ZHFo46qqxVpCyIifMhMF9DX7ZBljAuD
# fspKKyWDIOcDJ1Jt6FOdc9PNiYMyQFD+AZLDLM1ge/g4fe4NLojofOpMN0cYrYXo
# mWPmVLSX9WYWC70wcC+8VB5sG/TZKEVwDVbvRR9stZDlvKA1xQLtCWGD4xZBrLD0
# P1Km6jtfqndu/Ln+O7IgH5mMbZAotpab1HYNWuAa+7x6oij8zqimOmGAJKkUiwUS
# 0EFDNiJGSZsrOO93KdfK1t0AjYNuG0Uz3N3DbEa4/HAuROQMjYPJ1vWLgd0mmwGQ
# 8u31+80Hmq/3ODwv5s6CLskZ0ULSgcZI9VohwdwCbm0YPmTb17q4wPSofeHtOVZG
# VgvwLhIsnX5hR9uxn7C3zkZWYZSIoeLykrQjS+yK4NKVAm7xu6KRs3GT8EOmbQwW
# hbLtF2/mbo8d95mBYxACf/9jSrz64jV1KzkdHehhUD2PRvClU+8EBpRwOx407RiD
# ROyU6RQ=
