#
# Module manifest for module 'Akamai.Common'
#
...
GUID = '5627ab61-2e2e-4af9-8035-5512d4a25093'
...
Description = 'Common functions used by other Akamai-related PS modules'
...
FunctionsToExport = 'Clear-AkamaiDataCache', 'Clear-AkamaiOptions', 
               'Get-AkamaiCredentials', 'Get-AkamaiOptions', 'Get-AkamaiSession', 
               'Get-AuthGrants', 'Get-NetstorageCredentials', 
               'Invoke-AkamaiNSAPIRequest', 'Invoke-AkamaiRequest', 
               'Invoke-AkamaiRestMethod', 'New-AkamaiOptions', 'New-AkamaiSession', 
               'New-EdgeAuthToken', 'Remove-AkamaiSession', 'Set-AkamaiDataCache', 
               'Set-AkamaiOptions', 'Set-AkamaiSession', 'Test-OpenApi', 
               'Uninstall-Akamai', 'Confirm-Auth', 'ConvertFrom-Base64', 
               'ConvertTo-Base64', 'Expand-AkamaiError', 'Format-Filename', 
               'Format-QueryString', 'Get-AkamaiAuthHeader', 'Get-AkamaiUserAgent', 
               'Get-BodyObject', 'Get-EncryptedMessage', 'Get-RandomString', 
               'New-AkamaiDataCache', 'Test-ISO8601'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDJjROVqjZ+IYCI
# UEuFdCju/hffv5/Y5mvoHcOP5VYl7KCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgdpa2aqDlgly7n6mIa81wfxBiFXIdn1QBB2sN5Jo8MBYw
# DQYJKoZIhvcNAQEBBQAEggIAa8FNp79CDWtd3smCb5O04X4Au7/kLRhXJahYpyxO
# h5XpFpJFEEzg1iGSWRKLuPCHCegGHqw5YY4aWmygtRotSuxpe4fwrPBZtrnV8to0
# 9ILuIvtT6h9HNJ7N/1OVLwJdHphg2zt0nsyRJ1ex/odLSiHaK0o0/AiJK3Zr0Vpu
# bXhEg4SB0O/8XDTvsFlxUQni8xMQS93emjbkX/BY7bXg8btH/MLn/J3T1ml73ikK
# X1xlMlGJxRyt+i0URizrjEcyl4Rb+1w9mzOoqOLKNMKdM3YVFg6H5smBQXdkQR/0
# x7dBWVbz9h5VvPz/i2rhbXYQI5HENWioWyStAGJJ+YdH4YGVfTvZ3XZqNeen8NiN
# a6ncP9aQBdkVx0+MOtxo3rfw3iwCHngt8D8rDWlRjg+Jzz3SPr/h7nndkwzaFAPR
# bbPM4Vo2Ico9G6HvzdGjNvGMs8JDUkqZVrLTFtG5RfWbBohnq2GvZkrMF9qHoRuk
# BCRmBzuxdaOy0Et4imc4L1y7Jef/u4R65ZbGjdFUsDOvlPURzP9fuKMS65do016o
# pXYw1xUvzCaW5IiyQJmIf1ORnWWKQIo/+iLzgf9m3X8RIBVGDR/a5bs0ZwEK3jM4
# al+qBosuP7wDu3jMLK1t1YBVQbDhpiT1Wc3VZ9QUkqZdTPFvrACSchmNVwJmLEW9
# y2+hghd3MIIXcwYKKwYBBAGCNwMDATGCF2MwghdfBgkqhkiG9w0BBwKgghdQMIIX
# TAIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEEoGkEZzBlAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgxTwk3A6KkwMwBJrY+tplLwBEHi7M
# 2YQ6OlhgxYd08TECEQCqSEFCh1LYI5s2GFNKbVDrGA8yMDI1MTExNDAwMzAwNFqg
...
# MC8GCSqGSIb3DQEJBDEiBCDEUX9DihBv5whVixs5uzcikY8UzEXvIQEji1gnRHHn
# czA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBKoD+iLNdchMVck4+CjmdrnK7Ksz/j
# bSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASCAgAv7CGAOUjvw2CgxMyOODyrAxGS
# OcTSOyJTMN3REKjW75X6noGpSY8wrDChQNNEWSv8WQrITD1KvZj6KmunvWb79CHv
# ygCOoKx7rmD7b0Ob9VdhyB2CDTkyj/fxJ+HhUrwDDtTl5M/pX+Rt1te+/sOWAEUT
# cY4fSbz8W0dZNCW12i68vna+WSjwKtIaMuBaUUgLBmogLoh0INgtERnLmQCTfSmy
# rOrufzARpuoyxs1KmMD5xLQrP3M7/PkY9+NpSj2s0axsCVb6YTV3BLp6KbxNH6ju
# ql+hVk1K2x5aMAFNa8u8bVEpNGQ2bBKm1s7pW+YnIe78eb/1RUOjb9+Xni7WDDqo
# aqxfY3kfmYIsUpoc7lPvukM3hoEwYkirkErOgt8ygRWp5LvNIkyHonw2tOcmkdgD
# Vgr2PbV+qbSjavpRK76x5y48QHH2jVsG85YslYGXWS0htiP4DKBU24jn6dnsSPSL
# kCavZ6ZYtXZBQhEI+LB8vR0QkQh7ddiXoFGQQJxJ+NFpxVCXlOH3/h7ueHM8IwRQ
# Y8PNAB1xa8OYi2dlemAf3jpJDheaAfsw7Cyec4oT9fvlUDcnokiXfTgKO5f0ZRUj
# lq99Re34nfgsnIWh5plsQCh+q9tRWugK1u7kZk4+to7CdfO1bLpeq5IS6gTCa33y
# Tr3KUGzzs3KLqG35zg==
