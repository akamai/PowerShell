function Set-AkamaiDataCache {
    ...
    Param(
        [Parameter(ParameterSetName = 'APIDefinitions', Mandatory)]
        [string]
        $APIEndpointName,
        ...
        [Parameter(ParameterSetName = 'AppSecConfig', Mandatory)]
        [Parameter(ParameterSetName = 'AppSecPolicy', Mandatory)]
        [string]
        $AppSecConfigName,
        ...
        [Parameter(ParameterSetName = 'ClientLists', Mandatory)]
        [string]
        $ClientListName,
    ...
    # ---- API Endpoints
    if ($PSCmdlet.ParameterSetName -eq 'APIDefinitions') {
    ...
    # ---- Client Lists
    if ($PSCmdlet.ParameterSetName -eq 'ClientLists') {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC5h+4uHh+66nR6
# uGp3PbB1CgdlVItqVsWB3ppgk/cGW6CCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgB5uu73caxsdwzFMUuwsGfca6DJDhJyNuVG6l1VxNr+Qw
# DQYJKoZIhvcNAQEBBQAEggIAxT8vUpkCxWoExbNFcVb6lG4ki3NXEUJ5NeG/9PCB
# lVMSz6Mv3Y9c1yxNRq+vPsrYmLxHKzgF4+w58NUpJQC96r1vX01MITGxqPwhR+0N
# xaFyoLGGKNrT6w4YuhGNWyNMVor8Ewe+hAtg0ZRKjz2c7w+JibV3d3wDnTZHwcWo
# TvYymlzIYRT0lRciebKo//R+4WvEobgh3rJOZWoXWrWFAdCwNL5O6W2dgcQH3d+5
# GU3cUUSmNSyvqKPGZR0v7lVEWrpPafC+m/CIqEi8dklqWmt46kZSgxydfUMVu0z3
# KMY/sVl9MSCH2EA96ZiReg2d/67Gr6WGk5nFmTCe9YBpg6BXyI+uemrkWmp9ELkg
# bVTGISRt0+UO0VdC8VnEFhRdq8ZlRHG7od44uRvvNurgX79WYNkqb0on/iLaqagd
# 9kgLRW7xh7z+Ik9tLgNl/0XgjUMbIxprxiJSMxLvqGgSB129ZmFMtTomEBMC8Qc4
# wb/FcvQSHzsiITxDPQpVo9aK/l6x8dy2kAvKZdR01a2sO5K8v+WthxVr37jyC5AH
# eAr4Dn8d5kSY1XUvxMvMNfv8UY9q/cM7sUfaSX9vNasZpn1mlp9GFoR2WSYQ9Qml
# zzwYU9shOvHQaQcrDXQucuCrT3Bq1xF12MLdVA+WZwM1bTiSqBIbemq67It55De2
# rE+hghd3MIIXcwYKKwYBBAGCNwMDATGCF2MwghdfBgkqhkiG9w0BBwKgghdQMIIX
# TAIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEEoGkEZzBlAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgQPfOqSfNlQDDwus8mc1VtVRVVjNe
# sZ1RoPses3fUOHsCEQDH1s0INFWOtHkizuw17Q2CGA8yMDI1MDgwNTE4NDEwM1qg
...
# hvcNAQkDMQ0GCyqGSIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yNTA4MDUxODQx
# MDNaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFN1iMKyGCi0wa9o4sWh5UjAH+0F+
# MC8GCSqGSIb3DQEJBDEiBCCQhBs+sqofuJrQIwYJjbBuXcihemyfzIS7ItnHg5RM
# KDA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBKoD+iLNdchMVck4+CjmdrnK7Ksz/j
# bSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASCAgCB4SsAHxCE0QtLkX5CUu7554Gv
# fdVVn7jtCFlR6dcFIN/gKLESXYT3yap3Nulff6yt72uWhVobfMZRQ/7wKpJfr6qu
# osNhNbQQIGXEoedWOS6zRDAFMmezXFCWHL4IRB5b8e32ppdzWdJ/2zi+s9b/VRfb
# oUs46eiQ9rqwx+IRGu5Ns9XdnHH/MP3HDVfO9qOUqy5P8dMjXkIOz6VXGspWc+lT
# 4IoYOST78FOMX0ET7VOrSwiNc5NHseod+s4PLY+hqcwY1oA15bOFeKs5zIslx8Gb
# vsCtqztEEqh4sWxPRAqMnqL02So8eQiborqytMd7HwVpXpONqqBnVskA7N5n6xKR
# XDZ89GoGu6TfcqTtz6G/HvhPVScRVZ/vby6rPM+P/kK8sa0QBpFQYoyI75bJwPqM
# WBXEA5b2KWgAXmOtZLv4ScAuKqjxCjMqAnbLgoXuyhT85BMJKnhDxbt+eZg4+YDQ
# wygI3I80wSgBM4/zrlyfxU7FWjkS9LS3l7lGLV1XKCq6f+VKMq8Z8WlsRRQo/FUC
# jcdZF8LbE8kwbaPE7OehDcthBN6jljZf2advr5BfwZOtfi/88zFe63b5i7ryiqqu
# oVHRo9NRKEzZUp+Wpc3xnGmuHesNO6vl+FQqRPG8NzDJpFL0A2vA0uDr8Pw6Kx7x
# Kz6IY+s/UrtjwRax9Q==
