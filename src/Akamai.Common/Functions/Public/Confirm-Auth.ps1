<#
  .SYNOPSIS
  EdgeGrid credential validation.

  .DESCRIPTION
  The `Confirm-Auth` cmdlet verifies the format of EdgeGrid authentication credentials against regular expressions.

  .PARAMETER Auth
  An authentication object containing your credentials. 
  
  To get the object, run the `Get-AkamaiCredentials` cmdlet and save the output to a variable. Use the variable as the value. 

  .EXAMPLE
  Confirm-Auth -Auth $MyAuthObject

  There is no response if all credentials match standard format. 
#>
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCJ8O1SKa2VML7p
# eF9V31BmGC2QWzwIYb1+73mC5z9iHKCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgjLe7adRTfqGKHc8eIRhrCSNXONfoasZxL3q9Nr6KaEkw
# DQYJKoZIhvcNAQEBBQAEggIAlv/JIUdOt0UyFB8IEnl3zGdBUJ6ilvD0CEy1IhdN
# BKR5NyJHbjmnAYBYxGqVJig8S2RBIvbHx6d5OPn6JTDFHhb7qlZh/dh1DTGB7ADp
# eIKQiVcm3hZnnydjhVacAYSgYReUKDERuqjd2gPu/1vQ1glf3bEYgA873fwLhr3B
# IwF6TIMzFEpkySwyT2GjSORZZJ/HokzFS51QQrOH2PhzlmC9ICuelSS2JNy90SDC
# 4OPrNS15N6p0VsAxqivR/PA0QbDI5LZTMbWN1QqJK7ao2nAJ30RMblW9z8jXX5i8
# dcowoHFlshjj5z6TZdcUzd2qeKA+3BpumIiFOMFYbQXfSfBZoyPybR5gbLOToGlt
# o+ao+Qk5FyY3BJm77uV5Fp4anIZxCS+n5UhL4WDVN0diI41rkJ+vOI2Fg8dY+UNj
# g5CPx25M1HdpsyhVJrIiU5pPBcgeWh9d+bIhkEuPjhCB+4t5pXIeBmq6lzwdF4Db
# 4Xgi2OY6nw39WsaEEiE5n+n88bFkhzUKz4I2HZAWR1kOSylON0XOO+EkdXhMP9cK
# /5nzhGtcfAJMVW0rdHGjInPCeWiu9trzYi4Ou3umwRmEPmeIByvb2q6Cbnmxb7pK
# nscqMXHUJO1QJQmcWkRZ/GhkIxvg49RCOi47uoSzeGloeU7bRdXQcZzl79FzEk3G
# rW2hghc/MIIXOwYKKwYBBAGCNwMDATGCFyswghcnBgkqhkiG9w0BBwKgghcYMIIX
# FAIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEEoGgEZjBkAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgREsqPV8v5UE0+0QFHq6iexst8g6P
# GSmgUT1Y0xwa4m8CEB0ICo7S8Ws63hKyclM4gUMYDzIwMjQwODE1MTgwNjA0WqCC
...
# BgsqhkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjQwODE1MTgwNjA0WjArBgsq
# hkiG9w0BCRACDDEcMBowGDAWBBRm8CsywsLJD4JdzqqKycZPGZzPQDAvBgkqhkiG
# 9w0BCQQxIgQgvX2jLd519fRpmOpjoUYJ5hC5UjqbKGRzubV7DVSpPsUwNwYLKoZI
# hvcNAQkQAi8xKDAmMCQwIgQg0vbkbe10IszR1EBXaEE2b4KK2lWarjMWr00amtQM
# eCgwDQYJKoZIhvcNAQEBBQAEggIAcG1lgV4pqJY9r3+CGLRV7RWVwDRLbWDldn5P
# fpgkYOEiFoGLEB4Ic59g+fUO7zbHGshX9h2dxzarhzVnOw9kP81w3pFTslKv1UrI
# Tic2t8mdwdZ9xkjj4NskW34YYdO1DIpn7OuQ2Qao4NDqOgaAXloQrlzgpIPCejwD
# AN4RhgduEZKxlP8Ceg4QdVq5lHUIlYveHmbjC453Qh9R/oFMncc5DGm6fQt6s+Nb
# YtiBh8kVJ5Jz3M6B8/E7cBiKHVqKICZ2lOq5X1wzUxwwaZ2s4EIsbdG2x8VDxNN7
# KP9ft13vTSlnRUezsTK/VulZmYRnYKqU0SfD4wDKOJ4zCdGlX2DVeAES68YoBF3V
# rGFUtO8Vc5rPclTbvgrpWTjGlgwvuN2rRDVaw33Xl2RFgeWObPujWJ4focps8Dyg
# Ai8ELT3iEuMZa8VV5+1Ji4EA0Z9cG1BsvnmZSK4XNFcm74O3dtDoWvRpcS+Uo63E
# M6zDmvWl4Gw2EaMm08vf9F5fRS4Me8qENPIzKNwDM1I5EPROMkToDaiBes1VNdoP
# J+5l145iJT1Tl3QS37gDHeLi6hfItNzypvZYVp6lPikCYse0dP6GjacuQQzCkDD7
# 5i6sWzNZqsM8WEzHSAhiZMrN7Gw8fKwI89ND2v/qbVLfJRlMrkqGDyt7ZsBKN0vP
# Mvexux0=
