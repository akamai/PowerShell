...
function New-CloudWrapperConfigurationActivation {
    ...
    begin {
        $CollatedIDs = New-Object -TypeName System.Collections.Generic.List['int']
    }

    process {
        if ($ConfigurationIDs -is 'int') {
            $CollatedIDs.Add($ConfigurationIDs)
        }
    }
    
    end {
        $Path = "/cloud-wrapper/v1/configurations/activate"
        if ($CollatedIDs.Count -gt 0) {
            $ConfigurationIDs = $CollatedIDs
        }
        if ($ConfigurationIDs -is 'String') {
            $ConfigurationIDs = $ConfigurationIDs -Split ','
        }
        $Body = @{
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAw29eUw9+nV/Vm
# B4s8Ik1s7ipUDAMHOsnF5qd+GeutHqCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgLtqphtK2Eybf+M2xokpstma/mSFJPxhh6nzVLEGXtvkw
# DQYJKoZIhvcNAQEBBQAEggIAulcB5RpmS0t0k9ne2jV7oPdKMuu555VVukIYge22
# F/Qb35/Q1xPcRcuG/HVCHg6XReCXjD3yoj3SSyNivSWwGG/MybLa/KvkLwPAgInO
# SsP6XkzePyc6mXzAM/axvdpPf4b9B+9qn6q36THXCyOLqaTsuiJ7v/lrWmOQsvFJ
# zTEc5S6vqk2YgtHimcrgwFT83syJjP1pdANBxsC0yU0aeKmiDq6pgKSu2qtSWXBb
# mSirBJxxcThiBqso8ixInjwQ/Juc87fniUGb6K0XUxs2OkRSH0ZkGIEOxk6t19yz
# C43/VlIS9VZHt5KrNx3fHeMXCjgZyLoUTDnygRVSNVy3uNZHIQamvv4Wtz9RrWbs
# 0+LWLJ2sMASSO1s6r1t1SVXuJRhyTDO+gOkLXxGk73A20obK7e9mGl6o2MMUeafY
# CEmxwtDYJSzyXl5qq8TWenvXa6wnZGuV+SJ+S9C8sL2ALE/KLDsXt68lwmrt3NIk
# uRc7T6p+zEVgScGcbU16iIIWTn4jDANm95xPy7OzhhBwu4YftXaDNFzwCNBO2OYE
# vsmAFwIePbF6uivzwlnrE+jO9RvKY80cy+d/GLiFtVV0k6EWVzXwgw16L9rggocs
# K9PkKC6F/OE1D88n9URCq9lZoxp8WSomPC9KWwZHogdk7pN8glvqOa+/Y78U1m9+
# W8uhghd3MIIXcwYKKwYBBAGCNwMDATGCF2MwghdfBgkqhkiG9w0BBwKgghdQMIIX
# TAIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEEoGkEZzBlAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQg+77X5nG4W1+/lFUZjLU/Dj55fE4H
# wYC9rRBQPkK+3GcCEQDWflzOVDulUT3jv+MYW87SGA8yMDI1MDgwNTE4MDI0NFqg
...
# MC8GCSqGSIb3DQEJBDEiBCCQWaHtysWECHmC0aHQr+kQIsp58nIueBstfti5CYz2
# XDA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBKoD+iLNdchMVck4+CjmdrnK7Ksz/j
# bSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASCAgCBKHkWeUu9tJcxCKsgltL4lFJK
# IJUjJsg4BWiEupQNDYoUrTeGBhFSAUEl/JRe1bt0BkwEIABc1LwLT766Ohxylt6w
# lg03oOs1uytmwJQzoiNVxdiz8APS87pookmp/ZkW9sE9xFcQ7lLTZJyukNYm7FIl
# RrhJZWOFYTtN+M9kX8OLFCa985mTBgNBTj+ID4+oCMbq9rwai96Kc2NAmqhOmmxo
# tdzg+LSTeMhfHyV0OHq6PxmZ/+9idZSN4r9eymEx8zKAaE1ct44NTDBeC9fk0I8X
# 1raIGXLdrAc3qj7k6qRYwfraEK3IPYrvbJSqW7XM6TJlXMVrR2gHZWPA3WIgVoNN
# l2qWTseQkXs59G3luiV3SKQ4daA90wjOTNGIXxRDPmeMWuRJmW0bg/q+DksJZCuv
# 1kTUdc67aJeCtzuIYPiIJ9pnMxa9wlfjRG9cK0N8CLjUjSYPjmWj6rECoO3Lxibi
# 8Ju3zbF3xhMpg/C72M/ElZ7TCJV44srMQyKKzYyswgam54RbgZLcHj8+DjVXouHZ
# RkhqBBetUb2LsX0oh2ARlFTt855Zo/K/gniCfrh4/Q978lCr4WbOdZRod55FvraO
# iB42LZ5qg0cGHQyA6Z8sR6jXtb8muH/eijLxdCy4oVRG8AtSNWv/mx51+h29nQok
# TPzbJOgBYtgDo9SL1g==
