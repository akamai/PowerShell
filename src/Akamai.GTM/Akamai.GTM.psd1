#
# Module manifest for module 'Akamai.GTM'
#
...
GUID = '61950c66-c88e-4248-9601-8d2c71e8839b'
...
Description = 'Functions to manage the Akamai Global Traffic Manager APIs.'
...
FunctionsToExport = 'Get-GTMASMap', 'Get-GTMCIDRMap', 'Get-GTMDatacenter', 
               'Get-GTMDatacenterLatency', 'Get-GTMDemand', 'Get-GTMDomain', 
               'Get-GTMDomainHistory', 'Get-GTMDomainStatus', 'Get-GTMGeoMap', 
               'Get-GTMIPAvailability', 'Get-GTMLivenessPerProperty', 
               'Get-GTMLivenessTestError', 'Get-GTMLoadData', 
               'Get-GTMLoadFeedbackReport', 'Get-GTMProperty', 'Get-GTMResource', 
               'Get-GTMTrafficPerDatacenter', 'Get-GTMTrafficPerProperty', 
               'New-GTMASMap', 'New-GTMCIDRMap', 'New-GTMDatacenter', 
               'New-GTMDefaultDatacenter', 'New-GTMDefaultDatacenterForIP', 
               'New-GTMDomain', 'New-GTMGeoMap', 'New-GTMProperty', 'New-GTMResource', 
               'Remove-GTMASMap', 'Remove-GTMCIDRMap', 'Remove-GTMDatacenter', 
               'Remove-GTMGeoMap', 'Remove-GTMProperty', 'Remove-GTMResource', 
               'Set-GTMASMap', 'Set-GTMCIDRMap', 'Set-GTMDatacenter', 'Set-GTMDomain', 
               'Set-GTMGeoMap', 'Set-GTMProperty', 'Set-GTMResource', 
               'Submit-GTMLoadData'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDMbSQTFrXlDgIL
# JQXPd/MRUOZa1oBsG8sJS6S1ELIN9KCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgpUco9g7TMhr7NQVqrTPYS9zbIImyJffCjU9cZVx8Efkw
# DQYJKoZIhvcNAQEBBQAEggIAP9QNasD5XEUGmeZKQRk4TgoFIqACwefvo3gX9cEe
# +gZIef4/3N+8khR5wo2Il5bE8CVjIzcX/tVjVW5KXCY3WpdoGb54L2z+NbW7rSwu
# VAIYelzticWrqGglzag4CV+r5jb1qcMXA5ShuyBCvTv5hmR/Og+cAtu/r72vcZVj
# 1lzI6Ge1EX6bYXCO7IheTLdw7C5QpBfyFZRnN5LgIBNFWziNt+pmc7Cx3vRch1eG
# AKmarrQ3nzCG/dyBrQb5IE7EJcywHO6dNTWVvP+12OcH7l93E2KogO1HHsuiLW74
# dTlqprC+UwiC4E86Ty2rC9NJRutgjcZVO/Fofzq8LLbMUT4dq/fod2/85uAc3Ztj
