function New-GTMDefaultDatacenterForIP {
    ...
    $Path = "/config-gtm/v1/domains/$DomainName/datacenters/datacenter-for-ip-version-selector-$IPVersion"
    $AdditionalHeaders = @{ 'Accept' = 'application/vnd.config-gtm.v1.6+json' }

    try {
        $Result = Invoke-AkamaiRestMethod -Method POST -Path $Path -AdditionalHeaders $AdditionalHeaders -EdgeRCFile $EdgeRCFile -Section $Section -AccountSwitchKey $AccountSwitchKey
        return $Result
    }
    catch {
        throw $_
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBMI+4p5aMa6x24
# QfyvNR+lIAn7fzV2NhSlHDhOL2FzJKCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQg708oAnreNrClrOJdV1F5Ewe7U5KwTRWhDvjz9pcAICsw
# DQYJKoZIhvcNAQEBBQAEggIADtX9RIBdEP56pQfRNKgNCS1m8RW+LvCmKT4bDpKI
# BrLpjHKiUbciviUGTCk4fnIjshz3J5XJaevjSbZPDwW1BcMNQ3uEwHJN+n7IcGaY
# voZ+JiMVkF0ZtZ/f285buNIphakoPTYHaUZNwC0tL1wgCZMJbCIqOsfoLjxjDJ+2
# 7fRy8O0wBHAI7Ly7KrszjMDEhBO13Ol3QBs827ylTzjGrFzOAEzgP7Pcq3dWXWbM
# i9kMckuq7Y8whuVv/fh2PUU0FZUQDmJanjCpg8jJbsQeHzSip8pcOlkz4SvHp1un
# hZwvsniPakR+KC+KBzV5R0NNSuaMqduDGgR8l48sxFVYebLFhbqYaBqA4833l5O8
# u+3WwAPz9dlEiJUa6gGVqELRcLtficH1Q1TgZSILpICyagXRc+Do/KL4x1HzRp6F
# U+ZD34xxYh6z85Fz/UmZY81u12Jd4t11ZIqmfqqmM+pdLqyhDxe+vQzJQJtv6rLm
# CTQlXZk0rm4iqF+mGElNV+4xquTz/fDkMpNC4fSmBfW9nUN+Z6TCjIYH/2pX3U1n
# XaqNh/HjxNpmJE1AWubQXs4NieNVjoVX+Dt1oCj9to4iLqFTCN9bsuEkaYvy4Ew8
# mQUqbMnF5iJNtzJC6vFFxACx0qZOiw4xO0ug3xzFpQVITytoO+OGFZKZc5bQGpaA
# K1Khghc/MIIXOwYKKwYBBAGCNwMDATGCFyswghcnBgkqhkiG9w0BBwKgghcYMIIX
# FAIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEEoGgEZjBkAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgLMkiqlGskKAVuP/dfG/rMKrMLTgc
# JCPkbbLMxDM6yRgCEF8R2/5xHTzk16jPm2Og/ioYDzIwMjQwNDExMTYwMzUxWqCC
...
# BgsqhkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjQwNDExMTYwMzUxWjArBgsq
# hkiG9w0BCRACDDEcMBowGDAWBBRm8CsywsLJD4JdzqqKycZPGZzPQDAvBgkqhkiG
# 9w0BCQQxIgQgP21/swUSkb/nNuIkaVqhpK6WLjKiA3qG/SD//To341MwNwYLKoZI
# hvcNAQkQAi8xKDAmMCQwIgQg0vbkbe10IszR1EBXaEE2b4KK2lWarjMWr00amtQM
# eCgwDQYJKoZIhvcNAQEBBQAEggIAAW3xPsJYZQpes5YqfgCuD7o40P6a9jiBV0DP
# kjD410D7vXVRTZQppwA8br6/41bE9qWGGu0VjiKo7mePDv6XO1f/ZOEseUBW7kAO
# WRTpA/WIlVWuuUneHz4fmJIawVXa0DdtMR7Uf5s8w5CeGhn3kUxqgOGs+LEKONzh
# psxk/mPEwdyMg1xs2pfucxf+joMQpCA5Q55Ko9gYdM4PIgmgWd1wD4dRrYruflKd
# T2KQ+OZlKViqcC/UNQrdFoFtMtOHfNoSvfuunME3HX7USA/l4dgqYQ3ccBTzVxUK
# 7MIw/TjyTRz6ScyamB7/hUPeqvySlc9HhDxFoQMNwCcZyBoNZKIraeOme/xkea7R
# 9yi7FRXfOj3dlWtGEtlQ9+zBV8qsfs064xOE42Chb+Beoopx2sU4rbDtHiZMwlWY
# 6ZLzZBLowl1vyeKPxt6k6X2AGp/6mFeON4f6qDjTNeQ/gwdDCbO8xC4SkEfHQwmA
# TDRXbCEHOvmKEZYQKAv/2ono3CsFkChp09kZX7vNxKkRcOlSlADlm4pVeztVSapF
# 2WqxJ+Kixh2Oqt3Q4VWnujqV3paWJLlss17l5ANUtZIY7xofPa0r8APXMhSvU9CB
# xNkzUkkYPe5wj3kRO+pr+RGPWTaaCN+LXiwq6QRe5hHr/ilgOsI14hf6gU4SDtZ6
# C9k0dCc=
