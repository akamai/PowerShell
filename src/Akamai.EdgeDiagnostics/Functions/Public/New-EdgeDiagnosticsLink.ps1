function New-EdgeDiagnosticsLink {
    [CmdletBinding(DefaultParameterSetName = 'attributes-url')]
    Param(
        [Parameter(Mandatory, ParameterSetName = 'attributes-url')]
        [string]
        $URL,

        [Parameter(Mandatory, ParameterSetName = 'attributes-ipa')]
        [string]
        $IPAHostname,

        [Parameter(ParameterSetName = 'attributes-url')]
        [Parameter(ParameterSetName = 'attributes-ipa')]
        [string]
        $Note,
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDxuQ4fwRn/DOnv
# A9+8G6vzr5c6J3B25j5zTYwEPmdwL6CCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgSWdtxtTRjo94qlFbTk/ZN1u1vJNTUwue6ty8yQUVKY0w
# DQYJKoZIhvcNAQEBBQAEggIAC0Lezm5zDJESN/nK5fa9CkyA5PtNTO63R19mUNWR
# Ge0OgfUM6fJyJ8EnSLHyr4e+emq7Hn2p6Un7TSxV9aIJPQAjlHY/7svti4WxNEOj
# aBBmiMsQYJQc5wSfMLd+3I0BPRAty76RMWo1oMCMQTXCWwT5vInEavwFkThziLhP
# IBOlukA5txKYzI1htvbQFOeKijuDvdJsWsScdhLA72DAB4OVhOsQuAbQGkYtStt8
# CHj+baQpFssNycZXev9lv0NkrSiKPVu2Twpe09CdRI45TwP/0300pqSah4vdOCoS
# D36iZtUulYKQYIZ+vS42yFj98xSixTaK/LsGSddpDHeRpXQa0H3nt9ns4kPaqLQk
# ZZwyvipRf4sAo25Dg2217EDVlFKkH6yNMLSLd/4AMLfoFLBKrCCKuRcOasrAQ3E5
# oMQwESiuC48zy5ZoUmMEGTp0RxaWZT/PPhhclJ+p5gtY6YcDZH6r9408ImuzmPRv
# QPZJjRe5m1jWCOInhd8PuhIx3icFukmFcUaf+LHMjQXOKk8M718JFdnc1nNyT9V6
# 11cuFHqtYRLdwcIUvCJK+4tsCQxXRCUEcQjp6omq1WIUNsYVtWo0lGX38lxxpilb
# a+XeqA2Cj7FMmI3/yly3lm8+ZkvIk2uASHMIsoPwCjB1Yum4DZ7BR69ddQsSmmt0
# UNqhghd3MIIXcwYKKwYBBAGCNwMDATGCF2MwghdfBgkqhkiG9w0BBwKgghdQMIIX
# TAIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEEoGkEZzBlAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgt+5BwhhC7ma17TY2iLKllEkYSRUI
# TyAPwWQbMG0IYKUCEQDnt4wcGKMNTqmwIzytq+3gGA8yMDI1MTExMzIzMTIzM1qg
...
# hvcNAQkDMQ0GCyqGSIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yNTExMTMyMzEy
# MzNaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFN1iMKyGCi0wa9o4sWh5UjAH+0F+
# MC8GCSqGSIb3DQEJBDEiBCCz7Zsh73OeTzkuV2t5I3QriRTRTOzgPKz2NrsGWphN
# SjA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBKoD+iLNdchMVck4+CjmdrnK7Ksz/j
# bSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASCAgBYcuxRjY+tJdMQ4BfXqS0zmWUh
# tDirpvIjUK6Uzgi6gkwBbUyNFF90lqVRkyVhNjfoc3ExnvJ2ZMiZ9P0P/+MsB6Ns
# sMVKfn14aZhgz4gUW1XD5HMs5wuh3Pm5qFLKlmn0teU3FvRxYJhMlEl3P31qE1S9
# k6Hu9/ETXfOpMrHD0iMQUs6szbDw7Q8RJnxBxKbtZBO0k4XQsLVFw9nFdoP4bdYC
# 35GpzvcEg2quQLMjKqYmg4cpusxDbqiKlBtmx6Y3yYZlqdlcZEBNeAuPbDnSQ54D
# joqL/2Lw/0EzHTBJVJK1CB25IpssICxtrEwg2kQnCfFWkjmrbcgsc8kJmLiTTIX6
# 9eWH++iH1NxPFywKMXo9JHSaYizx+gU6wmI5zABFez9v1DZIAts27rPxNy6PazrZ
# oqLvsleFy7tqCnZPxiYhstTlYoGzRwzW0djwD8m0GjQ0neikm6VnZ5uA2GJ5PkRI
# vbCRw/AqOZvrZqRaBKZi2m9pGbzKpoJg0I9gbx0UgpIEfAPva0IiGEWrcA0c2VaH
# PhtNJ/lQi84oKoiFv4vc9++2TdflgrMbwZBU3Lkr6vaIaiYU8Xb94wjhunythGwd
# MZN/8jEYruLjV7flA7F1V/9gVGX3aWufoc9Y5skqRer8Sm6mqMuztSHL4EIq92vZ
# Jof/dRGSiVz2BZZy8Q==
