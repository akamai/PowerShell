function Get-EdgeDiagnosticsContentProblem {
    ...
    try {
        ...
        if ($Result -is 'String') {
            ...
            $ResultHash = $Result | ConvertFrom-Json -AsHashtable
            if ($AsHashTable) {
                return $ResultHash
            }
            else {
                $ResultHash['logLines'][0]['result'].Remove('legend')
                $ResultHash['summary']['logLines'][0]['result'].Remove('legend')
                $Result = $ResultHash | ConvertTo-Json -depth 100 | ConvertFrom-Json
            }
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCgf6FyoGyQBgxR
# tZNNfQy1LqFdnIS34UsvklyJXaNrOKCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgnTJ1u8dirN+Ac8T5B0dAvSqF+4NN6xxvZZeWltkK8rgw
# DQYJKoZIhvcNAQEBBQAEggIAih7H1Um0Y7NBdm7bG0q6RFmpJwO5kIhZkokJSU7t
# Rw6a33rXFrz7glFE3d9D31wAV91rKGMzMwD08ilF6fVz3l4Gv1hRPatyX2i7nLRi
# /EiGXSyDbW0x3/2LcHXQSbAoJLAicCQ8jC+K3Bx/gjVb8sRyfttV91iXA41I4p7Y
# NjT3hrHH8CeVmWnWSQ0qj1eGieIvUZCUniiFay/OcVY1oDeMfvZqLg+NmC11+l9l
# s+33GjcbBlHS+QwtpPhVBzY9zFj2J74laH1e204NLJgcRorsmEdFAwYjfr2D79RY
# /vsEGOFHu1ztlIkP0rXbproX8PnLlEgpuAZkPu/dglD7EdNdLwFZ9+D6cf71hfxg
# e8YUJpfMV5031k2w8wkV83Gb1Wc7jlkc7pfBhjBPpqR86TYyIMG4Q5pWrZE4uHtm
# MJXbpHXb7e7fkNlWabZtgTDpKf1XkYGObH63j63zQa//nrj5ZdUKo4G8FwDnNyep
# eQG7c465f9NY/KyVwCHFKRRSIattOJxN0wqB6RT6utTvw+6c4wn5ya8MziKaEiB9
# 2Sj44cfT5biRPW1k4UEMcNqMEQ4BmBkZ7f8ztFQmgZ7hopykfhyKZuOs8XTAHmrm
# Ot3rhlSDKzDQ1xZ61HbF66dKFjvNIsQxhYaYlyv3uXRn+Ojz7CUlNWzGtNbPHcw+
# D5Ohghc/MIIXOwYKKwYBBAGCNwMDATGCFyswghcnBgkqhkiG9w0BBwKgghcYMIIX
# FAIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEEoGgEZjBkAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgOu0hzVL5fC3/M29tr20BjngZIJvp
# NEVHw2S2cRcDFOMCEB4MRshY7kk/y1RetO4VjqIYDzIwMjQwODE1MTcyNjQzWqCC
...
# BgsqhkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjQwODE1MTcyNjQzWjArBgsq
# hkiG9w0BCRACDDEcMBowGDAWBBRm8CsywsLJD4JdzqqKycZPGZzPQDAvBgkqhkiG
# 9w0BCQQxIgQg9E3FopXGewVb6KmWVClA5zZ6ETg7/QfNLf3A/sO6czAwNwYLKoZI
# hvcNAQkQAi8xKDAmMCQwIgQg0vbkbe10IszR1EBXaEE2b4KK2lWarjMWr00amtQM
# eCgwDQYJKoZIhvcNAQEBBQAEggIAkGXgHvbn1pMsccxfJMb5PQDhuOKEQEc1au7m
# lMjoKHC/OZT6R7lMIhHwu6KlmqM5OhzuTbpErfw4W0ygK4LKAA8k2dcrW4V853uE
# 7KCHv+2+m6bnlfeMAdfQ0a+sZ/m6zu88IDJVmTTV+wLDiGJRb+ImAIpKyDYeADjM
# TEhsRzQsoHLCzgoAv7edQxfsOWeVlWttnrR4CnZvkvuIh+Rg9TRiwP5WXh9zPIgF
# b/QKBpOXFmeh64RKx+BI4jwi6ozKwMwrZz+IL0v8HT0iAWFW7xxd/zOZuQWu6ZuN
# sqF7YROS4albN5VVp22d/Js3RhUKd+4MTD/P21GyhcXgpmoPXcxA1IYKY0Rmhlx1
# wqJyGA49yvKrXJiQH+TYs4/5ZS38IT7fr8atrNOZNIDu4dOHplzA8LzLjRY1zwBy
# zD/Z5ZIZ4nicy5DQ8BWgYTvpiE+uKOQ5qUQq6MF1YgTcQoLLqzxsJ/9Sv6dozswF
# rfOrbiGpTGrL54Np50BlM/XJcS3RgbbY5/WCmU7JLnlw8ojhCLM3vj9yC2vvG8Cb
# XtdFPom+ScvPU+WW3o2yh9rPaZL/pGAsKOcv2gCAH1sz92T+mpZhVMc/lCZvRJsJ
# mu3zrWnR80xFo1V9UbYI4HQOK53CvMiExir+RcdJBiRD8oVImfKpwEhPfErX9qvR
# /UqVecs=
