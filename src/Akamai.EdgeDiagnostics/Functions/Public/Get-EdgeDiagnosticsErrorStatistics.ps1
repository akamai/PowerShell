function Get-EdgeDiagnosticsErrorStatistics {
    ...
    Param(
        [Parameter(Mandatory, ParameterSetName = 'cpcode')]
        [int]
        $CPCode,
    ...
    if ($URL -ne '') { $Body['url'] = $URL }
    if ($ErrorType -ne '') { $Body['errorType'] = $ErrorType }
    if ($Delivery -ne '') { $Body['delivery'] = $Delivery }
    $RequestParams = @{
        'Path'             = $Path
        'Method'           = 'POST'
        'Body'             = $Body
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAID+oWoI6cmHiP
# ztdalnq0Zwn/31SBM5UOK8Qj/VYfxqCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgeuG/q1g2f69DA51r6jin47nHS09OhjX4neyK0iz71cYw
# DQYJKoZIhvcNAQEBBQAEggIAWwSk1H7YVAJ8ii4KsGt8FMfU8+qI+KESDBC3ZTRo
# +Oqryc9xw9SHGFnfDD4VMG3DCDFW/dS7Dg4ywJzRMef6zQD0duRnh9RsOSUi5ZKV
# JCi0J8caGVHRvV1D2ATiAMli+/IS7KtsT8lQ2tytgiPlkdqpBmKRJgThPB/YkZn9
# SYxRb11FsdzYehygRW2WnidKdZOCqfM3+YY7cFR5efQZqjVBJESME81v4j62U+KE
# wbJAH03W0f09cBK0F6SpYC6QC5l+taI+ZwK+32Uc+jagxewBmImtjpgUxH0gzyYz
# nW/Lt0dVTdmW74HgpbrUc1s5XZ79J2u0AtVMc2WWvQIiR/ZNr1LsI3JGaxAftfpe
# /SSyipRjVlqjbh5bHC0yBL5MT/f77vHYIhyMh67OJhMZSfTlSLlhyfh0+ebHW4O2
# iXGmF1b/Dg1jRlNCS3c0NUKQ4ywFbgQvPuD+dG+ntmVSrt/uii/LHWgxX6sGt9Ej
# uQmKXcdGphQdjav8xQO9YVnNhIzFZiJZEn45CqmjF+7NYlY2VaJ1nCaGNrYGrZNS
# UM9GBfHhUgDpVXgJYb6zKG1Vi7AI8AYBas6Qd0mIOGJBsFHIkXm/J1D5AockSnYI
# mlacmToq5mHGe77sKnsMEMDC8aCUA6hZioNTjyFqSHTzvew/o1diMBoU4aohJVxA
# ss6hghd3MIIXcwYKKwYBBAGCNwMDATGCF2MwghdfBgkqhkiG9w0BBwKgghdQMIIX
# TAIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEEoGkEZzBlAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQg6RiykqnU3PeTygUJ0LOmN/1Yt6yI
# rWOjNNz8fSMNakcCEQC6gnpLt882qIAtIP6zLjo5GA8yMDI1MTExMzIzMTIyN1qg
...
# MjdaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFN1iMKyGCi0wa9o4sWh5UjAH+0F+
# MC8GCSqGSIb3DQEJBDEiBCBWRnYZQ3iFbCAO1DiacCggq83ZiqhbY53sbjaeKnSE
# TDA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBKoD+iLNdchMVck4+CjmdrnK7Ksz/j
# bSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASCAgBa4Y/2c/1S8kEoo/CNZllYBJLh
# fKLi6Kth3CzpG8SKLeZRfm8ii4B9mIHJZdUegOB5qnRH1fNCwjdYD0zg5i57DOKl
# 09xFYgAnwXY4kC24sgC5ELTMbKtt6pGVnhJz5nYah94GDQqK5AYzLcdkqN5w1U4J
# MYmO8gAghpNwH+V2HvRfw2TF6WB8igyXJ1trpaL51dgZtb8mrxDrWQtENUlFWrtQ
# tc3VEe9cAo/IMWW2NUNyfrGAXLaivlfAVETJwsPI3OpVN6Y9AHmnWfRTMWvLLSh8
# snlQVoU+LZRuZAwvW9KVPehbo6bfJBuKGf64wiai1ip2rngsjmsRoT+c3e/vOIFA
# DJq6XOWuKia/G48GrIPc15NZXHndEW3Cla3fvHEsB2SjhsnIiYZp+sqhcxXBU0Fl
# YEZCuyFoxizB1+SYOVH6dcu9Vk7vXePJq1b2oB/7g5rUJ+9VVhCi+5WTK6FTKhzc
# /TdBlesTb5lrigjN68/MSIS3G5HT9zmEqq6hEEAqCRyomAQk4nTOipX1ouf+oZqQ
# os4IUky+3nYLrsvaQrz68mluehXr3Lfb1BXrVT5+9DLcWBaKhlSpT/f6d+H1UE09
# sEpua3qsx1zXtdgTwphZ1kq0V60/DpPg5VTNm/oZE245CHFXcnyDfWwT648H2fen
# A65WFihXyIdqP306tA==
