function New-EdgeDiagnosticsCurl {
    [CmdletBinding(DefaultParameterSetName = 'attributes-ip')]
    Param(
        [Parameter(Mandatory, ParameterSetName = 'attributes-ip')]
        [Parameter(Mandatory, ParameterSetName = 'attributes-location')]
        [string]
        $URL,
        ...
        [Parameter(ParameterSetName = 'attributes-ip')]
        [Parameter(ParameterSetName = 'attributes-location')]
        [string]
        $SpoofEdgeIP,
    ...
    process {
        ...
        if ($PSCmdlet.ParameterSetName.StartsWith('attributes')) {
            ...
            if ($RequestHeaders -ne '') {
                $Body['requestHeaders'] = @()
                $RequestHeaders -split ',' | ForEach-Object {
                    $Body['requestHeaders'] += $_
                }
            }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCARmK7wtY/6RFJ9
# uXs0JtbCDbnwAWaWwv8vw3Wk0v21aaCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgFJlEiJykPnSJwTyBLhQ7mNOceEWhsGfs5rtJ6Cd3YhYw
# DQYJKoZIhvcNAQEBBQAEggIAnb1w60jlHKIZS0vI2DOS48gtj+ZqKpy/M956qe53
# /gXg9ZvUOAFwioJq7fruPm6Rhc5z2mlkkZVq0YM6KST8oK3ZTAAoNHMgDrlDi/p4
# uwiPfeVIJbvHwUZ/2fGpRSjMBky4VCua0fAABQVst51U7R+ZAVQ2lGo775IhJJAq
# tvzcdMR5z+bYjhjd6b937TwCGHUYS2CQU1ni9IxQi6hl+ChIbt/OO5MDs1qe9rye
# XoEHtKqvzL9zDwyTpnGClwVrgdnmvgg66WEAlyIIozotZBiLgFpgtR/XYxINMxfx
# V8Mw0iORMOZOCnebK7SDFyj6kny2luKo4EVEbTEOQuOkiPtGcuNSN+nCFYdjCg/o
# sXHNIlSTqhUXeaEVHx0+912DqKzijXTiN+7riWhUri8wvnjj4SV2g/xebHJb6nq/
# yjZ7Qry/rOe9SrseHcifxiMnnV3n6QaZ7p1cstCLh27tmUxI3JAS+kSj7IkNP2W0
# oJptCUuoaWRYQBWJJnIX0lUZVwpqYV6qa/NYi9QCGVyypZjYeG6zs0+EA4GBLaN+
# kIknYQih8f8nkPJDNFfgaYcHykzoZrUIOkbN9cUvA35Ej3AWD3/ISqNgZLlbLGls
# EMa8fYrJrjNST82ICQgRVSp9sbNkdG4DBNDXBo/WQsD+JmLI/yIsGzfftkSY6fX+
# r5Chghc5MIIXNQYKKwYBBAGCNwMDATGCFyUwghchBgkqhkiG9w0BBwKgghcSMIIX
# DgIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3DQEJEAEEoGgEZjBkAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgONEg41WYliCb6UOxPQEnMOQZtYNy
# MB9uxXoSxC1WJXMCEHoEokFqchN7gidhhPF5saAYDzIwMjUwNDAyMTYzOTMzWqCC
...
# 9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjUwNDAyMTYzOTMzWjArBgsqhkiG9w0B
# CRACDDEcMBowGDAWBBTb04XuYtvSPnvk9nFIUIck1YZbRTAvBgkqhkiG9w0BCQQx
# IgQgfRQE9V0MrS/fT3ihcKoZaXYjwD2LINmfMi2xXpdCZoIwNwYLKoZIhvcNAQkQ
# Ai8xKDAmMCQwIgQgdnafqPJjLx9DCzojMK7WVnX+13PbBdZluQWTmEOPmtswDQYJ
# KoZIhvcNAQEBBQAEggIArchPqGfxex/TzH3FqLEk/rEXEH4Q92cFKXjRLuIRIf2n
# ABiPmE++mHA4as7yZl5ZKjeuh0B72Vd+pN23RaaGBKgPW7zXuIx4D1iIWjk7y9fC
# a6U89cOXgm+bwI93KTIGWQ+cLgAlYisUposi39MRHJWTBWWsR26FSQmi4xNAhpDL
# CMb4Q2nncBtghAI/sgQGa8mcQhfqzRNkBpC/FWzxzvCxAw9b8QbKCNicPMyO/4cz
# odAcgF3Id5sY3XoLGk0N02+ujYqkthJIr41voyvPY+UXM0QSxbeLhJAJt2FyHHzB
# kDUUM95pLsLiKHRat4/baAXCi2qbWYCGe0v0xgbc5Hv46RJ0ulCGMv9JSRpXz0zH
# 9uleCdrv4qR/3SgTtOeobrmtLUifZFid/JSuiSA12TfDFaLfNHwXaRzjdx0mKZVS
# whJg6U8FEE09LYf3wt2+nTavMS7CJeECFaqZj6HAErwuwP/N+p8sQHQ7P6w1YWNb
# HVI/iBUQtjbh2GjGcTVrSo8CDXp9xJR7aaWd1uXFNX0mu9MK4PMoVizAzOYwNrHT
# 7RxoTDvDbDN+fkiYCrdQjgUln1dSFV08sGRw7au35MEasHm6VygyQdFgaalhIkjV
# 6+5Yg62n9XeB5Sz8lKGvHLVv4R4S5byZE4OGl018yF4B0y+qm+eRz9Ot7spLCjU=
