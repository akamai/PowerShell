#
# Module manifest for module 'Akamai.EdgeDNS'
#
...
RootModule = 'Akamai.EdgeDNS.psm1'
...
GUID = '4d8392c4-6199-4259-b8f7-68d89941b7a0'
...
Description = 'Functions to manage the Akamai EdgeDNS API.'
...
FunctionsToExport = 'Add-EDNSProxyZoneManualFilterName', 'Compare-EdnsZoneVersion', 
               'Convert-EDNSProxyZone', 'Convert-EDNSZoneToAlias', 
               'Convert-EDNSZoneToPrimary', 'Convert-EDNSZoneToSecondary', 
               'Find-EDNSChangeList', 'Get-EdnsAuthority', 'Get-EdnsChangeList', 
               'Get-EdnsChangeListDiff', 'Get-EdnsChangeListRecordSet', 
               'Get-EdnsChangeListRecordSetNames', 
               'Get-EdnsChangeListRecordSetTypes', 'Get-EdnsChangeListSettings', 
               'Get-EdnsContracts', 'Get-EDNSConvertResult', 'Get-EDNSConvertStatus', 
               'Get-EdnsDNSSECAlgorithms', 'Get-EdnsEdgeHostnames', 'Get-EdnsGroups', 
               'Get-EdnsMasterFile', 'Get-EDNSProxy', 
               'Get-EDNSProxyHealthcheckRecordTypes', 'Get-EDNSProxyZone', 
               'Get-EDNSProxyZoneCreateResult', 'Get-EDNSProxyZoneCreateStatus', 
               'Get-EDNSProxyZoneDeleteResult', 'Get-EDNSProxyZoneDeleteStatus', 
               'Get-EDNSProxyZoneManualFilterReport', 'Get-EDNSProxyZoneTSIGKey', 
               'Get-EDNSProxyZoneTSIGKeyUsedBy', 'Get-EdnsRecordSet', 
               'Get-EdnsRecordSetTypes', 'Get-EDNSSecondarySOA', 
               'Get-EdnsTSIGAlgorithms', 'Get-EdnsTSIGKey', 
               'Get-EDNSTSIGKeyContract', 'Get-EdnsTSIGKeyUsedBy', 'Get-EdnsZone', 
               'Get-EdnsZoneAlias', 'Get-EdnsZoneBulkCreateResult', 
               'Get-EdnsZoneBulkCreateStatus', 'Get-EdnsZoneBulkDeleteResult', 
               'Get-EdnsZoneBulkDeleteStatus', 'Get-EdnsZoneContract', 
               'Get-EdnsZoneDNSSECStatus', 'Get-EdnsZoneTransferStatus', 
               'Get-EdnsZoneVersion', 'Get-EdnsZoneVersionMasterFile', 
               'Get-EdnsZoneVersionRecordSet', 'New-EdnsChangeList', 'New-EDNSProxy', 
               'New-EDNSProxyZone', 'New-EdnsRecordSet', 'New-EdnsZone', 
               'New-EdnsZoneBulkCreate', 'New-EdnsZoneBulkDelete', 
               'Remove-EdnsChangeList', 'Remove-EDNSProxyZone', 
               'Remove-EDNSProxyZoneApexAlias', 
               'Remove-EDNSProxyZoneManualFilterName', 
               'Remove-EDNSProxyZoneTSIGKey', 'Remove-EdnsRecordSet', 
               'Remove-EdnsTSIGKey', 'Restore-EdnsZoneVersion', 
               'Set-EdnsChangeListMasterFile', 'Set-EdnsChangeListRecordSet', 
               'Set-EdnsChangeListSettings', 'Set-EdnsMasterFile', 'Set-EDNSProxy', 
               'Set-EDNSProxyZoneApexAlias', 'Set-EDNSProxyZoneManualFilterNames', 
               'Set-EDNSProxyZoneTSIGKey', 'Set-EdnsRecordSet', 'Set-EdnsTSIGKey', 
               'Set-EdnsZone', 'Submit-EdnsChangeList'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA