function Get-EDNSTSIGKeyUsedBy {
    [CmdletBinding(DefaultParameterSetName = 'same-key-attributes')]
    param (
        [Parameter(ParameterSetName = 'same-as-zone', Mandatory)]
        [string]
        $Zone,

        [Parameter(ParameterSetName = 'same-key-attributes', Mandatory)]
        ...
        [Parameter(ParameterSetName = 'same-key-postbody', ValueFromPipeline, Mandatory)]
        $Body,
    ...
    process {
        if ($PSCmdlet.ParameterSetName -eq 'same-as-zone') {
            $Method = 'GET'
            ...
            if ($PSCmdlet.ParameterSetName -ne 'same-key-postbody') {
                $Body = @{
        ...
        if ($PSCmdlet.ParameterSetName -ne 'same-as-zone') {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCYMEXJ7r66JGuO
# JjWiRA8AQ1QIpPJ4ADEVG6PFK2KfD6CCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgw0sipnAPLeItDCTRlPRNHmRnbOKu3pRUaDMM5WV8SIQw
# DQYJKoZIhvcNAQEBBQAEggIApjwy0cjE9rGA7r1meBruYhdXYggG5SL4C+u/WRxK
# XpIW+CgmlMiQy25rD34mfooG+wEQDFun5sCCyKHboqrBkWs+EY2xxharbp+8e5KY
# W4muw73QjgITNY9VyJ1utsmpYPU8GbvktrfN3fBh9gUTP23o4m3CoOgI6dSJWcnD
# pwYlJwE3/xqPQTxdXPUbiieYcDESFP1fJsuAXov3giRhyubl60FbF6UjnYU9wDqj
# tg+7V9g40SVfAKKAdQ85BGz2GRlILWJd54WFkjpbdv89B7BziZWhmz8+eOZCbvRq
# FjdDt+SxoGqf41Js5PI5glaurtK1nbRoK2sqJQPZ2+3VLkXj8Yf/nlEWVGmR+Qeo
# UxayZH/a22QbH8cfw9l4mPTz9Zz3+dYxwLVXEZBjujqqqZfaBWyOcww2EdB/oOCF
# Gt25AcpRLGheDuTY1kqzLtF7fk9xgzAeXvfyuDVFo9iNnL6Y5stlmMPjE/xtxAmx
# B5q0KTkJlPPO5NM006R9NMwOWrDq9FserhLZXDXRW3w5ueA8cNQMRPHKK/iExN/F
# i27xW7KGNIX0MH7Ptyu/aRofdNxBF3EX23DYH4Xx70y9UPjBvCS4p5tupOMtgPSd
# JkSaj0YUeeE3ywNO4N2a8suGKHe2P7l8CJGaJDe6kBiiNZdtPYHmAGzThKAf0v4E
# kPOhghd3MIIXcwYKKwYBBAGCNwMDATGCF2MwghdfBgkqhkiG9w0BBwKgghdQMIIX
# TAIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEEoGkEZzBlAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgOrgOch2XkAyqvfng0q/t7ytbQG+m
# JLGAXHtAphNFiVECEQCbYGKamLBhn4jEyzlwTU28GA8yMDI1MTExNDAwNDIyMVqg
...
# hvcNAQkDMQ0GCyqGSIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yNTExMTQwMDQy
# MjFaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFN1iMKyGCi0wa9o4sWh5UjAH+0F+
# MC8GCSqGSIb3DQEJBDEiBCDL/qyQQxJTfhzLhYB8ttpSB9FaSnjLiTyh9pU4DsxS
# QDA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBKoD+iLNdchMVck4+CjmdrnK7Ksz/j
# bSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASCAgCq7vKpZHnVE9W6U/3xD3pbLRXq
# Ntjk2h5GKOQ3MEXGoJ0sXJ36DBOyaj3nIjOSv/IiFhj9ho6HBlaGOTFjvBupVXpw
# jHoYWqJ644ik65Bo66XFOcmksb0y3Hbwm9eiYnMuaLXZ6rmLAtIQevTi74r+e4fm
# YGJM0pOpROVZL8RpkcvIt2jLXuBMm3gXOHW+VxUoh5u/dU60pmAstXs1ieanNty0
# HCZLKsCV2LxVIBOl5Gn+4oU+v5Wrn010KiVApiC14PLiyn7cjnpmv2fMa5/3PKTi
# 9dhYdxvzs77FfO5bYv5jw2XqEJ1baxBborciPbeDsI3QsPmbG8ESj4Dm/VibmqR/
# 8/GdYnZuPXJryODeSAeSgBYwm/hdWlKjhNthpKIpHde2OsqbwJubOPmNr4iJJurQ
# /bbTn5NdAbaL+vJcX7XcOM4jv8WWI4i9uKieaer2b1/gZv247/BsLI9sY4n9DUt7
# 7ASUhjHcWVLvdp9uqbB4Z29MVZIstuR3mky0eD1vBcKcIbA0gc5rF3szLXvST1az
# jbymMZbPPk+HzMKn6IxB+obYizCl5XgMWux/nMtxmET+Usox59apzzsEkMVDp/QW
# lZXYIFJAYHpIPm4xJHtvBJAF0Q1ElQ0NeajTmVYyr/4xn67Tqo/83u1SmjhHIzsE
# /3ID/voIuhyaeooBqg==
