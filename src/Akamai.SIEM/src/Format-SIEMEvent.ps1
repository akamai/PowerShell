function Format-SIEMEvent {
    ...
    $AttackDataAttributes | ForEach-Object {
        ...
        $URLdecodedString = Convert-URL -EncodedString $PlusSafeString
    ...
    $httpMessageAttributes | ForEach-Object {
        if ($SIEMEvent.httpMessage.$_) {
            Write-Debug "Parsing $_"
            $URLdecodedString = Convert-URL -EncodedString $SIEMEvent.httpMessage.$_
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDBJFHmhJGO/xDB
# U5dNSpqFdgZapzxGNCUsxUmv8I3VA6CCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgPgp0asD/R4KJAwksTwsenOHRbb3eSYyo97Z3DkegkOEw
# DQYJKoZIhvcNAQEBBQAEggIAvZkBnyRWJf9lWeE0EkT/fY4d6PIhJBwDIRcfrTMm
# FaJomGPlsFj4QFJJ7BubqDXiRaZ3fgQ5cEmY7pLmQItmGQMCSkMXupm/Yc7SCMyF
# 7T/suftSlEU/r13UHzw9doyqrwefUWf46hCHFn2sAlgZ1ttKCNQHR5swL2STTgfQ
# lm+A8ZYJ1XBEO+eOxTgj8mIrgLwLHIRn6HBs2tuffEqY7XeZr1TSNF/qf4t7VSzZ
# M4+QqhDoR+bh1FHjzeD6/QAyM0t5lusXHbjoAJMrJBDF1KjWmA2xD75ui6Uwf7KF
# X2GjPRYhQi2Ir47bZBeEAf/UMvjugguxx+A71BJW4Gm5V+JhGnmk/mlSOS2r7ljV
# AFyLuP96JW6Mxm2ryjkA7HZ/W32JdEko051fUVcu6pw5ojNPvNCE2lDrujMy5gb3
# wUvSiSBgQOioYChrBhdyNrxh6stwilRd9o9Ak2mIi8tEYemJKcWK3cU8tuTnKry1
# wfvZWTTso1QeKzDSdwb+NBk0hiDlyZYgGYJ6ySTiDBDezTX4DWJvrK8kRaCXfPj5
# YDmb0uM9h+DyfN/Jn4WsBhCB2Kx8vay6c/wpEzmmOtJ/Xe+KLoJYZcpIVVVkH0jQ
# ZPGh4EW3vhks4kkG1EXvXoOrtWgqg4BEMm3MgqylPMiZAP8mkhLORWOkjVLlM20q
# VvahghdAMIIXPAYKKwYBBAGCNwMDATGCFywwghcoBgkqhkiG9w0BBwKgghcZMIIX
# FQIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEEoGkEZzBlAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgAVKCAWcHyuIV1CNF6rXTi6gxLWzP
# 5EfUGl3LOwKFfWACEQCUolrLLSYEtX8to9lGke1LGA8yMDI0MDQxMTE2MzUzM1qg
...
# DQYLKoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI0MDQxMTE2MzUzM1owKwYL
# KoZIhvcNAQkQAgwxHDAaMBgwFgQUZvArMsLCyQ+CXc6qisnGTxmcz0AwLwYJKoZI
# hvcNAQkEMSIEIJiVYAzyqcRaZKMLJUeXW2wPB6MPXNMjv3XFQ+Aa5i1QMDcGCyqG
# SIb3DQEJEAIvMSgwJjAkMCIEINL25G3tdCLM0dRAV2hBNm+CitpVmq4zFq9NGprU
# DHgoMA0GCSqGSIb3DQEBAQUABIICAFBj32/1g3WGIQV/fIDW6xgBjyU7UU2+gGjv
# ESTBehuh006zaUwRkZUioeE7qLTF6NSa5X0Tevqh3deHwKE4u3VJNpLsrb+io8wN
# TCdrXpqjguPZzVpkEvRFz0wwIU9QVB37Oysaf0Sza30n2cDo/MzmHevDo51UTQ+M
# 8AnPJeFczGJLHxdRxnjFeaPtcMONQtozWNl/AiwZxsu8ZMuC/cih+EEGDctzc6VL
# MdCYhmJy6+L/t0BO+z8DJGLiBGDhyWM1mPfzBNcoK5If5dAxYwjnLcmWGQRJyrro
# EBB/rJ+RyBl+G23CAKI8r+a/pePiDw/0Nlju5gZ/xC0vhN5Qi8MO0LQe8s7E9Cp6
# 3mJBLETXYxe+nGYEuWDdttbkTQyLaqScOkNMHgqSa0bwetKsquSf7+Rg6ZeYJyCb
# wVDb5urLGiffbAs9FrOhFleYykM4XtKDjAMAhjfJXGZgiFKpKwH7MRqZ/3pu/GqS
# IfrpWtEGjBEPV4+095r7Zb8yrVyz7YpAcMxt1ah4i7+OMBQ8VJT5BU8f/BHAlF8k
# rn4baS2mGTuEqVkVGNS2Typ+5mhVd6v3w/e5LW4w3OwG/hH9GpavVs0s2cgXKFeh
# Cj9yw35/ChpxQSUqBOU2jFlulosiK7iGsynIJLEHBjMuUcVHlKBARrRSWoNnHc8/
# jrpkvWh7
