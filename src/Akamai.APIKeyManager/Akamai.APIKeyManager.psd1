#
# Module manifest for module 'Akamai.APIKeyManager'
#
...
RootModule = 'Akamai.APIKeyManager.psm1'
...
Description = 'Functions to manage the Akamai API Key Manager API.'
...
FunctionsToExport = 'Add-APIKeyToCollection', 'Export-APIKey', 'Get-APIKey', 
               'Get-ApiKeyCollection', 'Get-APIKeyCollectionACL', 
               'Get-APIKeyCollectionEndpoints', 'Get-APIKeyCollectionQuota', 
               'Get-APITag', 'Get-APIThrottlingCounter', 
               'Get-APIThrottlingCounterEndpoints', 
               'Get-APIThrottlingCounterKeyCollections', 
               'Get-APIThrottlingCounterKeys', 'Import-APIKey', 'Move-APIKey', 
               'New-APIKey', 'New-ApiKeyCollection', 'New-APIThrottlingCounter', 
               'Remove-APIKeyCollection', 'Remove-APIKeyFromCollection', 
               'Remove-APIThrottlingCounter', 'Reset-APIKeyCollectionQuota', 
               'Reset-APIKeyQuota', 'Restore-APIKey', 'Revoke-APIKey', 'Set-APIKey', 
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAsW0OeVnX1NxQb
# 9YhpxQ+os6KzyMgyiTDfXS3O9holFqCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgfIlj1HuqJGmaHJwUMX/W7R0oP3nZCHz9kaGFRRv7S3Aw
# DQYJKoZIhvcNAQEBBQAEggIAFJAqkkUxBg2SJmdJQdZCtL4nKt/g/pmPE2NJdCdV
# aoftiIqap0LoePQd17XD6PSfY3gGxCCYw47aOj4kNoAhIfKj3lSJ33LURtGtdUT9
# yJ8aFAH2VOCJQqRjg3QbZkApYMkSZQq8nkry5q1/FZBPeqsX5BoIbmiNA9N7jJ6x
# jGd1DEvtoNfc7G7BXajIF6UBLmVo89MFMkpO10962fWSsozHOTkAiXVfZpf2Ty4I
# L8Y3TzBs58It865PizLKRLo8sS9Jtr50HgHAGtvWnwvzvIgNOuA1MGd/bTuXtd8q
# FGXaE6AEcNrI5UnajfX+HBaggvwDiA4kfMIJu2jIqumfDaIqixrGq58N6owHeoZl
# b5Tk13pdOhJO9oBwDlLNjzGsw7bSWXSm0t2LGS4wQvfBdk6JPdCv5z2Wk2se07mC
# pYGH81H6w5Q1kAZ5y8w/UbzM2Wc48YXHwgBHsWVJpATYFCc7UMDni9YP9fjBVyBQ
# aKZx0FazESsIDZ0l7MGQVymG/57B63XQSz5uuYm3Vy8FMcGwwkyabMBk+dMxqlR0
# /SO7JUS1//CtU3zLMLbVDOBPIkXlOze+PKP+IJGDSDzuSF3iPeL3aiOvV8xNGJS/
# K/eknm3T7dMPq5MfK5Jn4miHYZc4uDw4EncuPVLlSN9Atu831nwkOUexqQv5m9sJ
# dvqhghd3MIIXcwYKKwYBBAGCNwMDATGCF2MwghdfBgkqhkiG9w0BBwKgghdQMIIX
# TAIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEEoGkEZzBlAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgosAxXYag5CatKOJT8bcH/V6ejIrG
# 2SlXoizhVDNCNSkCEQDcWwYFpxoCTHd/ltawnWlIGA8yMDI1MDgwNTE4MzcwMVqg
...
# hvcNAQkDMQ0GCyqGSIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yNTA4MDUxODM3
# MDFaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFN1iMKyGCi0wa9o4sWh5UjAH+0F+
# MC8GCSqGSIb3DQEJBDEiBCCVZfO/24QmmeogQ0kd9LU/uoYeFdJXaySrew6S9sFn
# BzA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBKoD+iLNdchMVck4+CjmdrnK7Ksz/j
# bSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASCAgDC48ngS7XuQ/0NRpe04jD9EAIh
# JQf1MI9mPRxKCDDGJh6AsiGR4jiBlKZff4PNbXWDN8bnOgEiHVyhbZJtyztw0UvO
# 2SYvxX+G8nXlGLfTE1nO+wf2VAsUH/YfhOOH2UIzyr3oNVSqrmYXpdMSf1hwWtqX
# JXTlIN51VYQ/m7PimG3t1/e4C7ZkOyXPiMLryx2hzumduLWdUppYztrm71XOdLFr
# kl1o0U5oHI8/f087xF2r4Q390eqORnahv4l5LcydNSoYScmE+z5vp4ifeceO2JH5
# 1d5p1zDjEmmnmQ4oJOBcgnEiemkk/XV7jn2KCyIUYdofNGqO4KWslQwuGrQk/1K1
# D3JqQU2hclqezKn6DcXcUaUD4lg8VkjR0mCyBkSzVXrCzLerO00ZqPlUNNkI3tz9
# XnODYyHA1nkSBYpzDPIxBKDzhqPPGMSDQeZSwyT37qdV1CcU+/x+RA/oNj3MvwMS
# IUyh5WHnqjFX2LOn+8LCWYGNXXNhANBR0O5Nx3VsTkV0yC38J0TApRaGpSvyoWa+
# QLZHonCqmNXdZmhowbZ1/pYCTMtgirpz2dxDbZ6/x7aTgUWGxdErpxSf2kuW1iQl
# gqT8zP4hqM4KUAoTXNYEGtKIn6wfzj9df7Jbok06T9GJTwqmu2MBI9CQ7ECNf8Xw
# /hC13KjhS2J4dHJvPg==
