#
# Module manifest for module 'Akamai.Datastream'
#
...
RootModule = 'Akamai.Datastream.psm1'
...
GUID = '232adcce-1285-4504-88db-0ad9e735f340'
...
Description = 'Functions to manage the Akamai Datastream 2 API.'
...
FunctionsToExport = 'Get-DataStream', 'Get-DataStreamActivationHistory', 
               'Get-DatastreamDatasets', 'Get-DatastreamEDNSZones', 
               'Get-DatastreamGroups', 'Get-DatastreamGTMProperties', 
               'Get-DataStreamHistory', 'Get-DataStreamMetrics', 
               'Get-DataStreamProperties', 'New-DataStream', 
               'New-DataStreamActivation', 'New-DataStreamDeactivation', 
               'Remove-DataStream', 'Set-DataStream', 'Update-DataStream'
...
AliasesToExport = 'Deploy-DataStream', 'Disable-DataStream'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAe+AVdyo/+iMyn
# 0+dZtqR9bRwmn1XjP6iQAGDUbEvLBaCCDo4wggawMIIEmKADAgECAhAIrUCyYNKc
...
# BgkqhkiG9w0BCQQxIgQgZ7mg+b7YSUJWmuLVqNswYLiKbvVSa01T5RNgkcxoQ6cw
# DQYJKoZIhvcNAQEBBQAEggIACFys01R4oFyZTEsct6DmmekcbkpW9/MtX5dp9IL2
# XcTVMA3yoHMmGTAKJ7Ah9hgmZYWxEGrFMldPnXU31hgrHEZ9ARkaK2+ODSpGGF9K
# a6AwbuH+PME6OUzruahTUdidis6m3rCOiHsIcGZHVdKv2+ZIKIdmmRDU1bUkHUz5
# 5utEJs5xGZoV3iXOLr8iQ+M4/N83Vg4EvEmMuOrzsGbdgpYFClnbkYnUTaLmhPa4
# 1Bbtshv9Oc7FRlqEokohR1VkGS9G4i5AdcA04zWhLrICln/JCJuzw7uSprl7AHCV
# 0D/IyscP+Hu+klIopbDQZNf3M+LuVMOyFnx+KWAOtFtQfcMRLZ65Z6IgiVNUJr6Z
# rSsvGvQ3SOI8wsHwTNx6D3JUiXOUchakBFrsVAmflpxih7dkJzitHZzXSUWuBiG1
# aZxzqJfVDs7DOA1vjKraG5rcXCuS8CYFnQRxhsyKHzeWCQYRDnLJUOtxVNr2QGQ7
# 05VyIGfpDrovPeC6CIOeXMg31pFYEr2rwEpdaY8ahWWVuXlX9lfRN7a7XNx8qro5
# 14qM3y+Ge39t7YVDV1+W4ltXk4iEqJlLkhadvbauHv5HRRFX1sxPXk0X37zvBWd5
# H1u4KACqenZXxHawqNfCrQTw1qLg4kWPimaliObdbmvj8R+7cb+TIoiyYwS8TNR9
# Drehghd3MIIXcwYKKwYBBAGCNwMDATGCF2MwghdfBgkqhkiG9w0BBwKgghdQMIIX
# TAIBAzEPMA0GCWCGSAFlAwQCAQUAMHgGCyqGSIb3DQEJEAEEoGkEZzBlAgEBBglg
# hkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgZxPSwheImIt5tXDK1oE2pMjpuW2C
# Zs+50pgVgkCAywsCEQDbPJPXiz677QRK8KbxEpqlGA8yMDI1MTExMzIyNDM1NVqg
...
# hvcNAQkDMQ0GCyqGSIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yNTExMTMyMjQz
# NTVaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFN1iMKyGCi0wa9o4sWh5UjAH+0F+
# MC8GCSqGSIb3DQEJBDEiBCCCFbU+uts0RQTTuUyTHwnseAhI/xXzMWcNeki/jxUT
# XzA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCBKoD+iLNdchMVck4+CjmdrnK7Ksz/j
# bSaaozTxRhEKMzANBgkqhkiG9w0BAQEFAASCAgCEcjGpECYIoa+egZwnnCegjkdS
# 0op/xKCzbgbJvbssJPKa8khEEh6jm+6UDUK+EJX/YgdrSCkCjg6SIzu4uL51xMgv
# BDSrg/OO/8xhqvWDjW5M76MItSocaZCtuQ8XuwpY35MbAa8bMnfFYF9x9R4Q1SBA
# qcRwjDEzdFzJp6rLFrxX+PEC3onWKBr8ZbJZ7mo/ec/zKG2b5MvJyKgQMaVqZofJ
# Ctd8SoCe0+B5329wfG5n+RMWKDRo55Y8tFxod7SsawAZR9lTDTg8DY9CAAeXZtzh
# xYlUpTgQDBiZm6HkfNbtcA5PSgOsY2xmfkZ4ZksTTv1ubuo9gCqj0uCOaLryejkw
# 3s25MMT+7gvhY2OE08iYHbtbwS0HdjMTTQjLh0sxPv69J07Q77HBmekSx8/mT3d4
# O/pb3VQTcH81YQxis/3oe2fk+fXt/HUMmACIqLZP5gJVuLOTjnRQBow6dA/YRQYF
# 0Re4IcxLE/Jaj1yDsfURKzzIexBkQPse/Tdu7FSLXobn519VR4faXDvowvaquMPQ
# fTHwSlx256gmnG9LRTKHan4VCyo2Fp51/g+DvLnF5I+1+kdDjyBvF0L61Yz79f3h
# DSxweRLA9uVWSgCVe2vtT7LiY3yKM4PF47GXCIePj3rtl30zsgo0LH8ZLmjxeS5a
# Ami0sDBoQW4iB6kHCg==
