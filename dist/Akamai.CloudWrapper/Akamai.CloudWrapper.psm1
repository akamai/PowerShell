...
function Get-CloudWrapperCapacity {
    [CmdletBinding()]
    Param(
        [Parameter()]
        [string[]]
    ...
    process {
        ...
        # Make Request
        $Response = Invoke-AkamaiRequest @RequestParams
        return $Response.Body.capacities
    }
...
function Get-CloudWrapperLocation {
    [CmdletBinding()]
    Param(
        [Parameter()]
        [string]
    ...
    process {
        $Path = "/cloud-wrapper/v1/locations"
        $RequestParams = @{
            'Path'             = $Path
            'Method'           = 'GET'
            'EdgeRCFile'       = $EdgeRCFile
...
function Get-CloudWrapperProvider {
    [CmdletBinding()]
    Param(
        [Parameter()]
        [string]
    ...
    process {
        $Path = "/cloud-wrapper/v1/multi-cdn/providers"
        $RequestParams = @{
            'Path'             = $Path
            'Method'           = 'GET'
            'EdgeRCFile'       = $EdgeRCFile
        ...
        # Make Request
        $Response = Invoke-AkamaiRequest @RequestParams
        return $Response.Body.cdnProviders
    }
}


function New-CloudWrapperConfiguration {
    [CmdletBinding()]
    Param(
        [Parameter()]
        [switch]
...
function Remove-CloudWrapperConfiguration {
    [CmdletBinding()]
    Param(
        [Parameter(Mandatory, ValueFromPipeline, ValueFromPipelineByPropertyName)]
        [int64]
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCeTJ+1cDoqBPGx
# okc46NUl9CXZQBRu13yTTL1HVQ43XqCCB1owggdWMIIFPqADAgECAhAGRzH371Sh
...
# AQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIPET7hFMBO3Lottyi18O+ze5ChcxpCQp
# zZwXvNFF1A0yMA0GCSqGSIb3DQEBAQUABIIBgFp8NKECnNZI+ew/R2QnQrBx1/L4
# aawUs1thvKu18V279no4+3mpOaCRpscy+QD0xSEGtDDsOU6EUKXDVeyXZ0jaGYRD
# NN/kvQ/XZRGT6MxGUmkK7EkaVM9b0rfTL7Ys1serC6EorDHoCIMhUSVBXEbH100J
# PhWcfsDRx6g9hyuWBPivmtn2YeY4Tjt1N6o16qBLgdUPD8Aa5IlidZ73d6H/etlb
# gTVJW1ZYu3Sjz+211q0aXMTMruSWYOE2uqp1l2LM6RHT+UsJ7ZSPCezWuoqh01ez
# Gpj0cItxLDx9AeT2AnjpNmIegrUIHlrayJxIPxJG7H4SCbRX8fkjQ3F8aILehIHD
# Y6ZGwT4EfGXJN5uHNrGhkWciarWIFwgFyAnCKbphoh7VARw+LUlUA/DBjm1n5b9h
# zP69ThM1faVA+LKJF6/8jvK5uPUw4L/1bNtDjy3rNBgknr7bu4wTKpaFW7oVg2OD
# n7+wfuHh5N9EugJAA/3vfcLUrn00D+qN9aO8mA==
